...
_stage1_test:     file format elf32-i386
...
int signal(int signum, sighandler_t handler)
{
  ...
  13:	e8 c0 03 00 00       	call   3d8 <regis>
	// regis(signum);
...
void handle_signal(int signum)
{
  ...
  2a:	c7 44 24 04 7c 08 00 	movl   $0x87c,0x4(%esp)
  31:	00 
  ...
  53:	e8 5f 04 00 00       	call   4b7 <printf>
  58:	eb 14                	jmp    6e <handle_signal+0x51>
	else
		printf(1, "TEST FAILED: wrong signal sent.\n");
  5a:	c7 44 24 04 a0 08 00 	movl   $0x8a0,0x4(%esp)
  61:	00 
  62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  69:	e8 49 04 00 00       	call   4b7 <printf>
	exit();
  6e:	e8 bd 02 00 00       	call   330 <exit>
...
int main(int argc, char *argv[])
{
  ...
  79:	83 ec 20             	sub    $0x20,%esp
	...
	// cprintf("%d", %eax);
	int x = 5;
  7c:	c7 44 24 1c 05 00 00 	movl   $0x5,0x1c(%esp)
  83:	00 
	int y = 0;
  84:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  8b:	00 
  ...
  a6:	c1 fa 1f             	sar    $0x1f,%edx
  a9:	f7 7c 24 18          	idivl  0x18(%esp)
  ad:	89 44 24 1c          	mov    %eax,0x1c(%esp)

	printf(1, "TEST FAILED: no signal sent.\n");
  b1:	c7 44 24 04 c1 08 00 	movl   $0x8c1,0x4(%esp)
  b8:	00 
  b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c0:	e8 f2 03 00 00       	call   4b7 <printf>
	
	exit();
  c5:	e8 66 02 00 00       	call   330 <exit>
  ca:	90                   	nop
  cb:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44e:	0f b6 90 60 0b 00 00 	movzbl 0xb60(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5ad:	75 27                	jne    5d6 <printf+0x11f>
          s = "(null)";
 5af:	c7 45 f4 df 08 00 00 	movl   $0x8df,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 67b:	a1 7c 0b 00 00       	mov    0xb7c,%eax
...
free(void *ap)
{
 ...
 73c:	a3 7c 0b 00 00       	mov    %eax,0xb7c
}
 741:	c9                   	leave  
 742:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 78f:	e8 d8 fe ff ff       	call   66c <free>
  return freep;
 794:	a1 7c 0b 00 00       	mov    0xb7c,%eax
}
 799:	c9                   	leave  
 79a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b0:	a1 7c 0b 00 00       	mov    0xb7c,%eax
 7b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7bc:	75 23                	jne    7e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 45 f0 74 0b 00 00 	movl   $0xb74,-0x10(%ebp)
 7c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c8:	a3 7c 0b 00 00       	mov    %eax,0xb7c
 7cd:	a1 7c 0b 00 00       	mov    0xb7c,%eax
 7d2:	a3 74 0b 00 00       	mov    %eax,0xb74
    base.s.size = 0;
 7d7:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 7de:	00 00 00 
  }
 ...
 834:	a3 7c 0b 00 00       	mov    %eax,0xb7c
      return (void*)(p + 1);
 ...
 83f:	eb 38                	jmp    879 <malloc+0xde>
    ...
    if(p == freep)
 841:	a1 7c 0b 00 00       	mov    0xb7c,%eax
