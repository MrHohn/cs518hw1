...
8010003a:	c7 44 24 04 54 85 10 	movl   $0x80108554,0x4(%esp)
80100041:	80 
...
80100198:	c7 04 24 5b 85 10 80 	movl   $0x8010855b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 6c 85 10 80 	movl   $0x8010856c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 73 85 10 80 	movl   $0x80108573,(%esp)
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 7a 85 10 80 	movl   $0x8010857a,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 83 85 10 80 	movl   $0x80108583,-0x14(%ebp)
      for(; *s; s++)
...
80100562:	c7 04 24 8a 85 10 80 	movl   $0x8010858a,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 99 85 10 80 	movl   $0x80108599,(%esp)
...
801005ab:	c7 04 24 9b 85 10 80 	movl   $0x8010859b,(%esp)
...
80100776:	e8 2a 64 00 00       	call   80106ba5 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 1e 64 00 00       	call   80106ba5 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 12 64 00 00       	call   80106ba5 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 05 64 00 00       	call   80106ba5 <uartputc>
  cgaputc(c);
...
80100a93:	c7 44 24 04 9f 85 10 	movl   $0x8010859f,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100aa2:	e8 d3 43 00 00       	call   80104e7a <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 a7 85 10 	movl   $0x801085a7,0x4(%esp)
80100aae:	80 
...
80100b78:	0f 85 44 03 00 00    	jne    80100ec2 <exec+0x3c6>
  ...
  if((pgdir = setupkvm()) == 0)
80100b7e:	e8 66 71 00 00       	call   80107ce9 <setupkvm>
...
80100c17:	e8 9f 74 00 00       	call   801080bb <allocuvm>
...
80100c54:	e8 73 73 00 00       	call   80107fcc <loaduvm>
...
80100cc4:	e8 f2 73 00 00       	call   801080bb <allocuvm>
...
80100ce8:	e8 f2 75 00 00       	call   801082df <clearpteu>
  sp = sz;
...
80100d5f:	e8 40 77 00 00       	call   801084a4 <copyout>
...
80100dff:	e8 a0 76 00 00       	call   801084a4 <copyout>
...
80100ea8:	e8 2d 6f 00 00       	call   80107dda <switchuvm>
  freevm(oldpgdir);
80100ead:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100eb0:	89 04 24             	mov    %eax,(%esp)
80100eb3:	e8 99 73 00 00       	call   80108251 <freevm>
  return 0;
...
80100eea:	e8 62 73 00 00       	call   80108251 <freevm>
  if(ip){
...
80100f12:	c7 44 24 04 ad 85 10 	movl   $0x801085ad,0x4(%esp)
80100f19:	80 
...
80100fa2:	7f 0c                	jg     80100fb0 <filedup+0x28>
    panic("filedup");
80100fa4:	c7 04 24 b4 85 10 80 	movl   $0x801085b4,(%esp)
...
80100fea:	7f 0c                	jg     80100ff8 <fileclose+0x28>
    panic("fileclose");
80100fec:	c7 04 24 bc 85 10 80 	movl   $0x801085bc,(%esp)
...
801011a1:	eb 0c                	jmp    801011af <fileread+0xba>
  ...
  panic("fileread");
801011a3:	c7 04 24 c6 85 10 80 	movl   $0x801085c6,(%esp)
...
801012af:	c7 04 24 cf 85 10 80 	movl   $0x801085cf,(%esp)
...
801012e2:	eb 0c                	jmp    801012f0 <filewrite+0x13f>
  ...
  panic("filewrite");
801012e4:	c7 04 24 df 85 10 80 	movl   $0x801085df,(%esp)
...
801014d4:	0f 82 e1 fe ff ff    	jb     801013bb <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014da:	c7 04 24 e9 85 10 80 	movl   $0x801085e9,(%esp)
...
80101571:	c7 04 24 ff 85 10 80 	movl   $0x801085ff,(%esp)
...
801015c5:	c7 44 24 04 12 86 10 	movl   $0x80108612,0x4(%esp)
801015cc:	80 
...
801016a6:	0f 82 5a ff ff ff    	jb     80101606 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016ac:	c7 04 24 19 86 10 80 	movl   $0x80108619,(%esp)
...
801017fa:	c7 04 24 2b 86 10 80 	movl   $0x8010862b,(%esp)
...
80101888:	7f 0c                	jg     80101896 <ilock+0x22>
    panic("ilock");
8010188a:	c7 04 24 3b 86 10 80 	movl   $0x8010863b,(%esp)
...
801019b2:	75 0c                	jne    801019c0 <ilock+0x14c>
      panic("ilock: no type");
801019b4:	c7 04 24 41 86 10 80 	movl   $0x80108641,(%esp)
...
801019e3:	7f 0c                	jg     801019f1 <iunlock+0x2f>
    panic("iunlock");
801019e5:	c7 04 24 50 86 10 80 	movl   $0x80108650,(%esp)
...
80101a70:	74 0c                	je     80101a7e <iput+0x57>
      panic("iput busy");
80101a72:	c7 04 24 58 86 10 80 	movl   $0x80108658,(%esp)
...
80101c06:	c7 04 24 62 86 10 80 	movl   $0x80108662,(%esp)
...
801020a0:	c7 04 24 75 86 10 80 	movl   $0x80108675,(%esp)
...
801020dc:	74 0c                	je     801020ea <dirlookup+0x5d>
      panic("dirlink read");
801020de:	c7 04 24 87 86 10 80 	movl   $0x80108687,(%esp)
...
801021c0:	74 0c                	je     801021ce <dirlink+0x79>
      panic("dirlink read");
801021c2:	c7 04 24 87 86 10 80 	movl   $0x80108687,(%esp)
...
80102238:	74 0c                	je     80102246 <dirlink+0xf1>
    panic("dirlink");
8010223a:	c7 04 24 94 86 10 80 	movl   $0x80108694,(%esp)
...
80102538:	c7 44 24 04 9c 86 10 	movl   $0x8010869c,0x4(%esp)
8010253f:	80 
...
801025e2:	75 0c                	jne    801025f0 <idestart+0x18>
    panic("idestart");
801025e4:	c7 04 24 a0 86 10 80 	movl   $0x801086a0,(%esp)
...
801027d2:	c7 04 24 a9 86 10 80 	movl   $0x801086a9,(%esp)
...
801027eb:	c7 04 24 bd 86 10 80 	movl   $0x801086bd,(%esp)
...
8010280a:	c7 04 24 d2 86 10 80 	movl   $0x801086d2,(%esp)
...
80102922:	c7 04 24 f0 86 10 80 	movl   $0x801086f0,(%esp)
...
801029e3:	c7 44 24 04 22 87 10 	movl   $0x80108722,0x4(%esp)
801029ea:	80 
...
80102a9d:	76 0c                	jbe    80102aab <kfree+0x39>
    panic("kfree");
80102a9f:	c7 04 24 27 87 10 80 	movl   $0x80108727,(%esp)
...
80102ef4:	c7 04 24 30 87 10 80 	movl   $0x80108730,(%esp)
...
8010325a:	c7 44 24 04 5c 87 10 	movl   $0x8010875c,0x4(%esp)
80103261:	80 
...
80103511:	c7 04 24 60 87 10 80 	movl   $0x80108760,(%esp)
...
80103688:	c7 04 24 6f 87 10 80 	movl   $0x8010876f,(%esp)
...
8010369d:	c7 04 24 85 87 10 80 	movl   $0x80108785,(%esp)
...
80103798:	c7 04 24 a0 87 10 80 	movl   $0x801087a0,(%esp)
...
801037b3:	e8 dc 32 00 00       	call   80106a94 <uartinit>
  pinit();         // process table
801037b8:	e8 8e 0b 00 00       	call   8010434b <pinit>
  tvinit();        // trap vectors
801037bd:	e8 45 2e 00 00       	call   80106607 <tvinit>
  binit();         // buffer cache
...
801037df:	e8 66 2d 00 00       	call   8010654a <timerinit>
...
8010380a:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010380d:	e8 ab 45 00 00       	call   80107dbd <switchkvm>
  seginit();
80103812:	e8 32 3f 00 00       	call   80107749 <seginit>
  lapicinit();
...
80103837:	c7 04 24 b7 87 10 80 	movl   $0x801087b7,(%esp)
8010383e:	e8 5e cb ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103843:	e8 33 2f 00 00       	call   8010677b <idtinit>
...
80103a23:	00 
80103a24:	c7 44 24 04 c8 87 10 	movl   $0x801087c8,0x4(%esp)
80103a2b:	80 
...
80103b64:	00 
80103b65:	c7 44 24 04 cd 87 10 	movl   $0x801087cd,0x4(%esp)
80103b6c:	80 
...
80103c3e:	8b 04 85 10 88 10 80 	mov    -0x7fef77f0(,%eax,4),%eax
...
80103c77:	c7 04 24 d2 87 10 80 	movl   $0x801087d2,(%esp)
...
80103d0a:	c7 04 24 f0 87 10 80 	movl   $0x801087f0,(%esp)
...
8010400f:	c7 44 24 04 24 88 10 	movl   $0x80108824,0x4(%esp)
80104016:	80 
...
80104351:	c7 44 24 04 29 88 10 	movl   $0x80108829,0x4(%esp)
80104358:	80 
...
80104448:	ba bc 65 10 80       	mov    $0x801065bc,%edx
...
801044a6:	e8 3e 38 00 00       	call   80107ce9 <setupkvm>
...
801044bb:	c7 04 24 30 88 10 80 	movl   $0x80108830,(%esp)
...
801044e1:	e8 5b 3a 00 00       	call   80107f41 <inituvm>
  p->sz = PGSIZE;
...
80104581:	00 
80104582:	c7 44 24 04 49 88 10 	movl   $0x80108849,0x4(%esp)
80104589:	80 
8010458a:	89 04 24             	mov    %eax,(%esp)
8010458d:	e8 88 0d 00 00       	call   8010531a <safestrcpy>
  p->cwd = namei("/");
80104592:	c7 04 24 52 88 10 80 	movl   $0x80108852,(%esp)
...
801045e6:	e8 d0 3a 00 00       	call   801080bb <allocuvm>
...
80104620:	e8 70 3b 00 00       	call   80108195 <deallocuvm>
...
80104649:	e8 8c 37 00 00       	call   80107dda <switchuvm>
  return 0;
...
8010468e:	e8 92 3c 00 00       	call   80108325 <copyuvm>
...
801047e4:	75 0c                	jne    801047f2 <exit+0x22>
    panic("init exiting");
801047e6:	c7 04 24 54 88 10 80 	movl   $0x80108854,(%esp)
...
801048c2:	e8 87 03 00 00       	call   80104c4e <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048c7:	81 45 f4 7c 04 00 00 	addl   $0x47c,-0xc(%ebp)
801048ce:	81 7d f4 94 48 12 80 	cmpl   $0x80124894,-0xc(%ebp)
...
801048e4:	e8 ba 01 00 00       	call   80104aa3 <sched>
  panic("zombie exit");
801048e9:	c7 04 24 61 88 10 80 	movl   $0x80108861,(%esp)
...
8010496a:	e8 e2 38 00 00       	call   80108251 <freevm>
        p->state = UNUSED;
...
801049af:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049b0:	81 45 f4 7c 04 00 00 	addl   $0x47c,-0xc(%ebp)
801049b7:	81 7d f4 94 48 12 80 	cmpl   $0x80124894,-0xc(%ebp)
...
80104a41:	e8 94 33 00 00       	call   80107dda <switchuvm>
      p->state = RUNNING;
...
80104a6a:	e8 21 09 00 00       	call   80105390 <swtch>
      switchkvm();
80104a6f:	e8 49 33 00 00       	call   80107dbd <switchkvm>
...
80104a81:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a82:	81 45 f4 7c 04 00 00 	addl   $0x47c,-0xc(%ebp)
80104a89:	81 7d f4 94 48 12 80 	cmpl   $0x80124894,-0xc(%ebp)
...
80104ab9:	c7 04 24 6d 88 10 80 	movl   $0x8010886d,(%esp)
...
80104ad4:	74 0c                	je     80104ae2 <sched+0x3f>
    panic("sched locks");
80104ad6:	c7 04 24 7f 88 10 80 	movl   $0x8010887f,(%esp)
...
80104aee:	75 0c                	jne    80104afc <sched+0x59>
    panic("sched running");
80104af0:	c7 04 24 8b 88 10 80 	movl   $0x8010888b,(%esp)
...
80104b0a:	c7 04 24 99 88 10 80 	movl   $0x80108899,(%esp)
...
80104bc1:	75 0c                	jne    80104bcf <sleep+0x1c>
    panic("sleep");
80104bc3:	c7 04 24 ad 88 10 80 	movl   $0x801088ad,(%esp)
...
80104bd5:	c7 04 24 b3 88 10 80 	movl   $0x801088b3,(%esp)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c7d:	81 45 fc 7c 04 00 00 	addl   $0x47c,-0x4(%ebp)
80104c84:	81 7d fc 94 48 12 80 	cmpl   $0x80124894,-0x4(%ebp)
...
kill(int pid)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d12:	81 45 f4 7c 04 00 00 	addl   $0x47c,-0xc(%ebp)
80104d19:	81 7d f4 94 48 12 80 	cmpl   $0x80124894,-0xc(%ebp)
...
80104d81:	eb 07                	jmp    80104d8a <procdump+0x55>
      ...
      state = "???";
80104d83:	c7 45 ec c4 88 10 80 	movl   $0x801088c4,-0x14(%ebp)
...
80104da5:	c7 04 24 c8 88 10 80 	movl   $0x801088c8,(%esp)
...
80104deb:	c7 04 24 d1 88 10 80 	movl   $0x801088d1,(%esp)
...
80104e0a:	75 d4                	jne    80104de0 <procdump+0xab>
    ...
    cprintf("\n");
80104e0c:	c7 04 24 d5 88 10 80 	movl   $0x801088d5,(%esp)
...
80104e1a:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e1b:	81 45 f0 7c 04 00 00 	addl   $0x47c,-0x10(%ebp)
80104e22:	81 7d f0 94 48 12 80 	cmpl   $0x80124894,-0x10(%ebp)
...
80104eb3:	74 0c                	je     80104ec1 <acquire+0x26>
    panic("acquire");
80104eb5:	c7 04 24 01 89 10 80 	movl   $0x80108901,(%esp)
...
80104f10:	75 0c                	jne    80104f1e <release+0x21>
    panic("release");
80104f12:	c7 04 24 09 89 10 80 	movl   $0x80108909,(%esp)
...
8010503f:	c7 04 24 11 89 10 80 	movl   $0x80108911,(%esp)
...
80105068:	79 0c                	jns    80105076 <popcli+0x4b>
    panic("popcli");
8010506a:	c7 04 24 28 89 10 80 	movl   $0x80108928,(%esp)
...
8010557a:	c7 04 24 2f 89 10 80 	movl   $0x8010892f,(%esp)
...
80105a12:	c7 04 24 4b 89 10 80 	movl   $0x8010894b,(%esp)
...
80105aac:	c7 44 24 04 5d 89 10 	movl   $0x8010895d,0x4(%esp)
80105ab3:	80 
...
80105ac7:	c7 44 24 04 5f 89 10 	movl   $0x8010895f,0x4(%esp)
80105ace:	80 
...
80105b1f:	c7 04 24 62 89 10 80 	movl   $0x80108962,(%esp)
...
80105b96:	74 0c                	je     80105ba4 <sys_unlink+0x159>
    panic("unlink: writei");
80105b98:	c7 04 24 74 89 10 80 	movl   $0x80108974,(%esp)
...
80105cf3:	75 0c                	jne    80105d01 <create+0xde>
    panic("create: ialloc");
80105cf5:	c7 04 24 83 89 10 80 	movl   $0x80108983,(%esp)
...
80105d63:	c7 44 24 04 5d 89 10 	movl   $0x8010895d,0x4(%esp)
80105d6a:	80 
...
80105d84:	c7 44 24 04 5f 89 10 	movl   $0x8010895f,0x4(%esp)
80105d8b:	80 
...
80105d99:	79 0c                	jns    80105da7 <create+0x184>
      panic("create dots");
80105d9b:	c7 04 24 92 89 10 80 	movl   $0x80108992,(%esp)
...
80105dc7:	c7 04 24 9e 89 10 80 	movl   $0x8010899e,(%esp)
...
80106413:	eb 6c                	jmp    80106481 <sys_sleep+0x90>
  acquire(&tickslock);
80106415:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
8010641c:	e8 7a ea ff ff       	call   80104e9b <acquire>
  ticks0 = ticks;
80106421:	a1 e0 50 12 80       	mov    0x801250e0,%eax
...
80106436:	74 13                	je     8010644b <sys_sleep+0x5a>
      release(&tickslock);
80106438:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
...
8010644b:	c7 44 24 04 a0 48 12 	movl   $0x801248a0,0x4(%esp)
80106452:	80 
80106453:	c7 04 24 e0 50 12 80 	movl   $0x801250e0,(%esp)
8010645a:	e8 54 e7 ff ff       	call   80104bb3 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010645f:	a1 e0 50 12 80       	mov    0x801250e0,%eax
...
8010646e:	72 bb                	jb     8010642b <sys_sleep+0x3a>
  ...
  release(&tickslock);
80106470:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
...
80106486:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106489:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
80106490:	e8 06 ea ff ff       	call   80104e9b <acquire>
  xticks = ticks;
80106495:	a1 e0 50 12 80       	mov    0x801250e0,%eax
8010649a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010649d:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
...
801064b1:	83 ec 18             	sub    $0x18,%esp
  char *p = "Shutdown";
801064b4:	c7 45 fc ae 89 10 80 	movl   $0x801089ae,-0x4(%ebp)
  for( ; *p; p++)
...
80106518:	8b 4d f4             	mov    -0xc(%ebp),%ecx
8010651b:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010651e:	83 c1 1c             	add    $0x1c,%ecx
80106521:	89 54 88 0c          	mov    %edx,0xc(%eax,%ecx,4)
...
80106538:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010653c:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010653f:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106543:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106547:	ee                   	out    %al,(%dx)
}
80106548:	c9                   	leave  
80106549:	c3                   	ret    
...
80106550:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106557:	00 
80106558:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010655f:	e8 c8 ff ff ff       	call   8010652c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106564:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010656b:	00 
8010656c:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106573:	e8 b4 ff ff ff       	call   8010652c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106578:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010657f:	00 
80106580:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106587:	e8 a0 ff ff ff       	call   8010652c <outb>
  picenable(IRQ_TIMER);
8010658c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106593:	e8 69 d8 ff ff       	call   80103e01 <picenable>
}
80106598:	c9                   	leave  
80106599:	c3                   	ret    
	...
...
8010659d:	06                   	push   %es
  pushl %fs
8010659e:	0f a0                	push   %fs
  pushl %gs
801065a0:	0f a8                	push   %gs
  pushal
801065a2:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801065a3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801065a7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801065a9:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801065ab:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801065af:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801065b1:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801065b3:	54                   	push   %esp
  call trap
801065b4:	e8 de 01 00 00       	call   80106797 <trap>
  addl $4, %esp
801065b9:	83 c4 04             	add    $0x4,%esp
...
801065bc:	61                   	popa   
  popl %gs
801065bd:	0f a9                	pop    %gs
  popl %fs
801065bf:	0f a1                	pop    %fs
  popl %es
801065c1:	07                   	pop    %es
  popl %ds
801065c2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801065c3:	83 c4 08             	add    $0x8,%esp
  iret
801065c6:	cf                   	iret   
	...
...
801065f8:	0f 20 d3             	mov    %cr2,%ebx
801065fb:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
801065fe:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106614:	e9 c3 00 00 00       	jmp    801066dc <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106619:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661c:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
80106623:	89 c2                	mov    %eax,%edx
80106625:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106628:	66 89 14 c5 e0 48 12 	mov    %dx,-0x7fedb720(,%eax,8)
8010662f:	80 
80106630:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106633:	66 c7 04 c5 e2 48 12 	movw   $0x8,-0x7fedb71e(,%eax,8)
8010663a:	80 08 00 
8010663d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106640:	0f b6 14 c5 e4 48 12 	movzbl -0x7fedb71c(,%eax,8),%edx
80106647:	80 
80106648:	83 e2 e0             	and    $0xffffffe0,%edx
8010664b:	88 14 c5 e4 48 12 80 	mov    %dl,-0x7fedb71c(,%eax,8)
80106652:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106655:	0f b6 14 c5 e4 48 12 	movzbl -0x7fedb71c(,%eax,8),%edx
8010665c:	80 
8010665d:	83 e2 1f             	and    $0x1f,%edx
80106660:	88 14 c5 e4 48 12 80 	mov    %dl,-0x7fedb71c(,%eax,8)
80106667:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010666a:	0f b6 14 c5 e5 48 12 	movzbl -0x7fedb71b(,%eax,8),%edx
80106671:	80 
80106672:	83 e2 f0             	and    $0xfffffff0,%edx
80106675:	83 ca 0e             	or     $0xe,%edx
80106678:	88 14 c5 e5 48 12 80 	mov    %dl,-0x7fedb71b(,%eax,8)
8010667f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106682:	0f b6 14 c5 e5 48 12 	movzbl -0x7fedb71b(,%eax,8),%edx
80106689:	80 
8010668a:	83 e2 ef             	and    $0xffffffef,%edx
8010668d:	88 14 c5 e5 48 12 80 	mov    %dl,-0x7fedb71b(,%eax,8)
80106694:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106697:	0f b6 14 c5 e5 48 12 	movzbl -0x7fedb71b(,%eax,8),%edx
8010669e:	80 
8010669f:	83 e2 9f             	and    $0xffffff9f,%edx
801066a2:	88 14 c5 e5 48 12 80 	mov    %dl,-0x7fedb71b(,%eax,8)
801066a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ac:	0f b6 14 c5 e5 48 12 	movzbl -0x7fedb71b(,%eax,8),%edx
801066b3:	80 
801066b4:	83 ca 80             	or     $0xffffff80,%edx
801066b7:	88 14 c5 e5 48 12 80 	mov    %dl,-0x7fedb71b(,%eax,8)
801066be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066c1:	8b 04 85 a0 b0 10 80 	mov    -0x7fef4f60(,%eax,4),%eax
801066c8:	c1 e8 10             	shr    $0x10,%eax
801066cb:	89 c2                	mov    %eax,%edx
801066cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d0:	66 89 14 c5 e6 48 12 	mov    %dx,-0x7fedb71a(,%eax,8)
801066d7:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801066d8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801066dc:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801066e3:	0f 8e 30 ff ff ff    	jle    80106619 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801066e9:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
801066ee:	66 a3 e0 4a 12 80    	mov    %ax,0x80124ae0
801066f4:	66 c7 05 e2 4a 12 80 	movw   $0x8,0x80124ae2
801066fb:	08 00 
801066fd:	0f b6 05 e4 4a 12 80 	movzbl 0x80124ae4,%eax
80106704:	83 e0 e0             	and    $0xffffffe0,%eax
80106707:	a2 e4 4a 12 80       	mov    %al,0x80124ae4
8010670c:	0f b6 05 e4 4a 12 80 	movzbl 0x80124ae4,%eax
80106713:	83 e0 1f             	and    $0x1f,%eax
80106716:	a2 e4 4a 12 80       	mov    %al,0x80124ae4
8010671b:	0f b6 05 e5 4a 12 80 	movzbl 0x80124ae5,%eax
80106722:	83 c8 0f             	or     $0xf,%eax
80106725:	a2 e5 4a 12 80       	mov    %al,0x80124ae5
8010672a:	0f b6 05 e5 4a 12 80 	movzbl 0x80124ae5,%eax
80106731:	83 e0 ef             	and    $0xffffffef,%eax
80106734:	a2 e5 4a 12 80       	mov    %al,0x80124ae5
80106739:	0f b6 05 e5 4a 12 80 	movzbl 0x80124ae5,%eax
80106740:	83 c8 60             	or     $0x60,%eax
80106743:	a2 e5 4a 12 80       	mov    %al,0x80124ae5
80106748:	0f b6 05 e5 4a 12 80 	movzbl 0x80124ae5,%eax
8010674f:	83 c8 80             	or     $0xffffff80,%eax
80106752:	a2 e5 4a 12 80       	mov    %al,0x80124ae5
80106757:	a1 a0 b1 10 80       	mov    0x8010b1a0,%eax
8010675c:	c1 e8 10             	shr    $0x10,%eax
8010675f:	66 a3 e6 4a 12 80    	mov    %ax,0x80124ae6
  
  initlock(&tickslock, "time");
80106765:	c7 44 24 04 b8 89 10 	movl   $0x801089b8,0x4(%esp)
8010676c:	80 
8010676d:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
80106774:	e8 01 e7 ff ff       	call   80104e7a <initlock>
}
80106779:	c9                   	leave  
8010677a:	c3                   	ret    
...
8010677e:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106781:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106788:	00 
80106789:	c7 04 24 e0 48 12 80 	movl   $0x801248e0,(%esp)
80106790:	e8 33 fe ff ff       	call   801065c8 <lidt>
}
80106795:	c9                   	leave  
80106796:	c3                   	ret    
...
8010679d:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
801067a0:	8b 45 08             	mov    0x8(%ebp),%eax
801067a3:	8b 40 30             	mov    0x30(%eax),%eax
801067a6:	83 f8 40             	cmp    $0x40,%eax
801067a9:	75 3e                	jne    801067e9 <trap+0x52>
    if(proc->killed)
801067ab:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067b1:	8b 40 24             	mov    0x24(%eax),%eax
801067b4:	85 c0                	test   %eax,%eax
801067b6:	74 05                	je     801067bd <trap+0x26>
      exit();
801067b8:	e8 13 e0 ff ff       	call   801047d0 <exit>
    proc->tf = tf;
801067bd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067c3:	8b 55 08             	mov    0x8(%ebp),%edx
801067c6:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801067c9:	e8 3f ed ff ff       	call   8010550d <syscall>
    if(proc->killed)
801067ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067d4:	8b 40 24             	mov    0x24(%eax),%eax
801067d7:	85 c0                	test   %eax,%eax
801067d9:	0f 84 64 02 00 00    	je     80106a43 <trap+0x2ac>
      exit();
801067df:	e8 ec df ff ff       	call   801047d0 <exit>
    return;
801067e4:	e9 5a 02 00 00       	jmp    80106a43 <trap+0x2ac>
  }

  switch(tf->trapno){
801067e9:	8b 45 08             	mov    0x8(%ebp),%eax
801067ec:	8b 40 30             	mov    0x30(%eax),%eax
801067ef:	83 f8 3f             	cmp    $0x3f,%eax
801067f2:	0f 87 ef 00 00 00    	ja     801068e7 <trap+0x150>
801067f8:	8b 04 85 60 8a 10 80 	mov    -0x7fef75a0(,%eax,4),%eax
801067ff:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106801:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106807:	0f b6 00             	movzbl (%eax),%eax
8010680a:	84 c0                	test   %al,%al
8010680c:	75 31                	jne    8010683f <trap+0xa8>
      acquire(&tickslock);
8010680e:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
80106815:	e8 81 e6 ff ff       	call   80104e9b <acquire>
      ticks++;
8010681a:	a1 e0 50 12 80       	mov    0x801250e0,%eax
8010681f:	83 c0 01             	add    $0x1,%eax
80106822:	a3 e0 50 12 80       	mov    %eax,0x801250e0
      wakeup(&ticks);
80106827:	c7 04 24 e0 50 12 80 	movl   $0x801250e0,(%esp)
8010682e:	e8 5c e4 ff ff       	call   80104c8f <wakeup>
      release(&tickslock);
80106833:	c7 04 24 a0 48 12 80 	movl   $0x801248a0,(%esp)
8010683a:	e8 be e6 ff ff       	call   80104efd <release>
    }
    lapiceoi();
8010683f:	e8 db c6 ff ff       	call   80102f1f <lapiceoi>
    break;
80106844:	e9 74 01 00 00       	jmp    801069bd <trap+0x226>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106849:	e8 af be ff ff       	call   801026fd <ideintr>
    lapiceoi();
8010684e:	e8 cc c6 ff ff       	call   80102f1f <lapiceoi>
    break;
80106853:	e9 65 01 00 00       	jmp    801069bd <trap+0x226>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106858:	e8 76 c4 ff ff       	call   80102cd3 <kbdintr>
    lapiceoi();
8010685d:	e8 bd c6 ff ff       	call   80102f1f <lapiceoi>
    break;
80106862:	e9 56 01 00 00       	jmp    801069bd <trap+0x226>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106867:	e8 dc 03 00 00       	call   80106c48 <uartintr>
    lapiceoi();
8010686c:	e8 ae c6 ff ff       	call   80102f1f <lapiceoi>
    break;
80106871:	e9 47 01 00 00       	jmp    801069bd <trap+0x226>
  case T_IRQ0 + 7:
...
80106876:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106879:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
8010687f:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106883:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106896:	89 54 24 08          	mov    %edx,0x8(%esp)
8010689a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010689e:	c7 04 24 c0 89 10 80 	movl   $0x801089c0,(%esp)
801068a5:	e8 f7 9a ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801068aa:	e8 70 c6 ff ff       	call   80102f1f <lapiceoi>
    break;
801068af:	e9 09 01 00 00       	jmp    801069bd <trap+0x226>
  case T_DIVIDE:
    // if(proc->handler[proc->signum] != 0)
    if(proc->handler[SIGFPE] != -1)
801068b4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068ba:	8b 40 7c             	mov    0x7c(%eax),%eax
801068bd:	83 f8 ff             	cmp    $0xffffffff,%eax
801068c0:	74 25                	je     801068e7 <trap+0x150>
...
801068df:	89 50 38             	mov    %edx,0x38(%eax)
      ...
      // *(tf->esp + 0x08) = 0x17;
      break;
801068e2:	e9 d6 00 00 00       	jmp    801069bd <trap+0x226>
    }
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
...
801068ef:	74 11                	je     80106902 <trap+0x16b>
801068f1:	8b 45 08             	mov    0x8(%ebp),%eax
801068f4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068f8:	0f b7 c0             	movzwl %ax,%eax
801068fb:	83 e0 03             	and    $0x3,%eax
801068fe:	85 c0                	test   %eax,%eax
80106900:	75 46                	jne    80106948 <trap+0x1b1>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106902:	e8 ea fc ff ff       	call   801065f1 <rcr2>
...
80106907:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010690a:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010690d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106914:	0f b6 12             	movzbl (%edx),%edx
    }
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106917:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010691a:	8b 55 08             	mov    0x8(%ebp),%edx
    }
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010691d:	8b 52 30             	mov    0x30(%edx),%edx
80106920:	89 44 24 10          	mov    %eax,0x10(%esp)
80106924:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106928:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010692c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106930:	c7 04 24 e4 89 10 80 	movl   $0x801089e4,(%esp)
80106937:	e8 65 9a ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010693c:	c7 04 24 16 8a 10 80 	movl   $0x80108a16,(%esp)
80106943:	e8 f5 9b ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106948:	e8 a4 fc ff ff       	call   801065f1 <rcr2>
8010694d:	89 c2                	mov    %eax,%edx
...
8010694f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106952:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106955:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010695b:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010695e:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106961:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106964:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106967:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010696a:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010696d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106973:	83 c0 6c             	add    $0x6c,%eax
...
80106979:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010697f:	8b 40 10             	mov    0x10(%eax),%eax
80106982:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106986:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010698a:	89 74 24 14          	mov    %esi,0x14(%esp)
8010698e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106992:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106996:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106999:	89 54 24 08          	mov    %edx,0x8(%esp)
8010699d:	89 44 24 04          	mov    %eax,0x4(%esp)
801069a1:	c7 04 24 1c 8a 10 80 	movl   $0x80108a1c,(%esp)
801069a8:	e8 f4 99 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801069ad:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069b3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801069ba:	eb 01                	jmp    801069bd <trap+0x226>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801069c5:	74 24                	je     801069eb <trap+0x254>
801069c7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069cd:	8b 40 24             	mov    0x24(%eax),%eax
801069d0:	85 c0                	test   %eax,%eax
801069d2:	74 17                	je     801069eb <trap+0x254>
801069d4:	8b 45 08             	mov    0x8(%ebp),%eax
801069d7:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801069db:	0f b7 c0             	movzwl %ax,%eax
801069de:	83 e0 03             	and    $0x3,%eax
801069e1:	83 f8 03             	cmp    $0x3,%eax
801069e4:	75 05                	jne    801069eb <trap+0x254>
  {
    // cprintf("in trap's killed judging function\n");
    // if(tf->trapno != 0)
    // {
      exit(); 
801069e6:	e8 e5 dd ff ff       	call   801047d0 <exit>
    // }
  }
...
801069f3:	74 1e                	je     80106a13 <trap+0x27c>
801069f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069fb:	8b 40 0c             	mov    0xc(%eax),%eax
801069fe:	83 f8 04             	cmp    $0x4,%eax
80106a01:	75 10                	jne    80106a13 <trap+0x27c>
80106a03:	8b 45 08             	mov    0x8(%ebp),%eax
80106a06:	8b 40 30             	mov    0x30(%eax),%eax
80106a09:	83 f8 20             	cmp    $0x20,%eax
80106a0c:	75 05                	jne    80106a13 <trap+0x27c>
    yield();
80106a0e:	e8 42 e1 ff ff       	call   80104b55 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106a13:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a19:	85 c0                	test   %eax,%eax
80106a1b:	74 27                	je     80106a44 <trap+0x2ad>
80106a1d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a23:	8b 40 24             	mov    0x24(%eax),%eax
80106a26:	85 c0                	test   %eax,%eax
80106a28:	74 1a                	je     80106a44 <trap+0x2ad>
...
80106a3a:	75 08                	jne    80106a44 <trap+0x2ad>
    exit();
80106a3c:	e8 8f dd ff ff       	call   801047d0 <exit>
80106a41:	eb 01                	jmp    80106a44 <trap+0x2ad>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106a44:	83 c4 3c             	add    $0x3c,%esp
80106a47:	5b                   	pop    %ebx
80106a48:	5e                   	pop    %esi
80106a49:	5f                   	pop    %edi
80106a4a:	5d                   	pop    %ebp
...
80106a50:	83 ec 14             	sub    $0x14,%esp
80106a53:	8b 45 08             	mov    0x8(%ebp),%eax
80106a56:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106a5a:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106a5e:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106a62:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106a66:	ec                   	in     (%dx),%al
80106a67:	89 c3                	mov    %eax,%ebx
80106a69:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106a6c:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106a70:	83 c4 14             	add    $0x14,%esp
80106a73:	5b                   	pop    %ebx
80106a74:	5d                   	pop    %ebp
80106a75:	c3                   	ret    
...
80106a7f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a82:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a86:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a89:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a8d:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
...
80106aa1:	00 
80106aa2:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106aa9:	e8 c8 ff ff ff       	call   80106a76 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106aae:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106ab5:	00 
80106ab6:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106abd:	e8 b4 ff ff ff       	call   80106a76 <outb>
  outb(COM1+0, 115200/9600);
80106ac2:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106ac9:	00 
80106aca:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106ad1:	e8 a0 ff ff ff       	call   80106a76 <outb>
  outb(COM1+1, 0);
80106ad6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106add:	00 
80106ade:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ae5:	e8 8c ff ff ff       	call   80106a76 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106aea:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106af1:	00 
80106af2:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106af9:	e8 78 ff ff ff       	call   80106a76 <outb>
  outb(COM1+4, 0);
80106afe:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b05:	00 
80106b06:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b0d:	e8 64 ff ff ff       	call   80106a76 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b12:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b19:	00 
80106b1a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b21:	e8 50 ff ff ff       	call   80106a76 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b26:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b2d:	e8 1a ff ff ff       	call   80106a4c <inb>
80106b32:	3c ff                	cmp    $0xff,%al
80106b34:	74 6c                	je     80106ba2 <uartinit+0x10e>
    return;
  uart = 1;
80106b36:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106b3d:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b40:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b47:	e8 00 ff ff ff       	call   80106a4c <inb>
  inb(COM1+0);
80106b4c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b53:	e8 f4 fe ff ff       	call   80106a4c <inb>
  picenable(IRQ_COM1);
80106b58:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b5f:	e8 9d d2 ff ff       	call   80103e01 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106b64:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b6b:	00 
80106b6c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b73:	e8 0a be ff ff       	call   80102982 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106b78:	c7 45 f4 60 8b 10 80 	movl   $0x80108b60,-0xc(%ebp)
80106b7f:	eb 15                	jmp    80106b96 <uartinit+0x102>
    uartputc(*p);
...
80106b8d:	e8 13 00 00 00       	call   80106ba5 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106b9e:	75 e1                	jne    80106b81 <uartinit+0xed>
80106ba0:	eb 01                	jmp    80106ba3 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106bfa:	e8 77 fe ff ff       	call   80106a76 <outb>
80106bff:	eb 01                	jmp    80106c02 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106c07:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c0a:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
...
80106c21:	e8 26 fe ff ff       	call   80106a4c <inb>
...
80106c3e:	e8 09 fe ff ff       	call   80106a4c <inb>
...
80106c55:	e8 53 9b ff ff       	call   801007ad <consoleintr>
}
80106c5a:	c9                   	leave  
80106c5b:	c3                   	ret    
...
80106c5e:	6a 00                	push   $0x0
  jmp alltraps
80106c60:	e9 37 f9 ff ff       	jmp    8010659c <alltraps>
...
80106c67:	6a 01                	push   $0x1
  jmp alltraps
80106c69:	e9 2e f9 ff ff       	jmp    8010659c <alltraps>
...
80106c70:	6a 02                	push   $0x2
  jmp alltraps
80106c72:	e9 25 f9 ff ff       	jmp    8010659c <alltraps>
...
80106c79:	6a 03                	push   $0x3
  jmp alltraps
80106c7b:	e9 1c f9 ff ff       	jmp    8010659c <alltraps>
...
80106c82:	6a 04                	push   $0x4
  jmp alltraps
80106c84:	e9 13 f9 ff ff       	jmp    8010659c <alltraps>
...
80106c8b:	6a 05                	push   $0x5
  jmp alltraps
80106c8d:	e9 0a f9 ff ff       	jmp    8010659c <alltraps>
...
80106c94:	6a 06                	push   $0x6
  jmp alltraps
80106c96:	e9 01 f9 ff ff       	jmp    8010659c <alltraps>
...
80106c9d:	6a 07                	push   $0x7
  jmp alltraps
80106c9f:	e9 f8 f8 ff ff       	jmp    8010659c <alltraps>
...
80106ca4:	6a 08                	push   $0x8
  jmp alltraps
80106ca6:	e9 f1 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cad:	6a 09                	push   $0x9
  jmp alltraps
80106caf:	e9 e8 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cb4:	6a 0a                	push   $0xa
  jmp alltraps
80106cb6:	e9 e1 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cbb:	6a 0b                	push   $0xb
  jmp alltraps
80106cbd:	e9 da f8 ff ff       	jmp    8010659c <alltraps>
...
80106cc2:	6a 0c                	push   $0xc
  jmp alltraps
80106cc4:	e9 d3 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cc9:	6a 0d                	push   $0xd
  jmp alltraps
80106ccb:	e9 cc f8 ff ff       	jmp    8010659c <alltraps>
...
80106cd0:	6a 0e                	push   $0xe
  jmp alltraps
80106cd2:	e9 c5 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cd9:	6a 0f                	push   $0xf
  jmp alltraps
80106cdb:	e9 bc f8 ff ff       	jmp    8010659c <alltraps>
...
80106ce2:	6a 10                	push   $0x10
  jmp alltraps
80106ce4:	e9 b3 f8 ff ff       	jmp    8010659c <alltraps>
...
80106ce9:	6a 11                	push   $0x11
  jmp alltraps
80106ceb:	e9 ac f8 ff ff       	jmp    8010659c <alltraps>
...
80106cf2:	6a 12                	push   $0x12
  jmp alltraps
80106cf4:	e9 a3 f8 ff ff       	jmp    8010659c <alltraps>
...
80106cfb:	6a 13                	push   $0x13
  jmp alltraps
80106cfd:	e9 9a f8 ff ff       	jmp    8010659c <alltraps>
...
80106d04:	6a 14                	push   $0x14
  jmp alltraps
80106d06:	e9 91 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d0d:	6a 15                	push   $0x15
  jmp alltraps
80106d0f:	e9 88 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d16:	6a 16                	push   $0x16
  jmp alltraps
80106d18:	e9 7f f8 ff ff       	jmp    8010659c <alltraps>
...
80106d1f:	6a 17                	push   $0x17
  jmp alltraps
80106d21:	e9 76 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d28:	6a 18                	push   $0x18
  jmp alltraps
80106d2a:	e9 6d f8 ff ff       	jmp    8010659c <alltraps>
...
80106d31:	6a 19                	push   $0x19
  jmp alltraps
80106d33:	e9 64 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d3a:	6a 1a                	push   $0x1a
  jmp alltraps
80106d3c:	e9 5b f8 ff ff       	jmp    8010659c <alltraps>
...
80106d43:	6a 1b                	push   $0x1b
  jmp alltraps
80106d45:	e9 52 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d4c:	6a 1c                	push   $0x1c
  jmp alltraps
80106d4e:	e9 49 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d55:	6a 1d                	push   $0x1d
  jmp alltraps
80106d57:	e9 40 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d5e:	6a 1e                	push   $0x1e
  jmp alltraps
80106d60:	e9 37 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d67:	6a 1f                	push   $0x1f
  jmp alltraps
80106d69:	e9 2e f8 ff ff       	jmp    8010659c <alltraps>
...
80106d70:	6a 20                	push   $0x20
  jmp alltraps
80106d72:	e9 25 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d79:	6a 21                	push   $0x21
  jmp alltraps
80106d7b:	e9 1c f8 ff ff       	jmp    8010659c <alltraps>
...
80106d82:	6a 22                	push   $0x22
  jmp alltraps
80106d84:	e9 13 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d8b:	6a 23                	push   $0x23
  jmp alltraps
80106d8d:	e9 0a f8 ff ff       	jmp    8010659c <alltraps>
...
80106d94:	6a 24                	push   $0x24
  jmp alltraps
80106d96:	e9 01 f8 ff ff       	jmp    8010659c <alltraps>
...
80106d9d:	6a 25                	push   $0x25
  jmp alltraps
80106d9f:	e9 f8 f7 ff ff       	jmp    8010659c <alltraps>
...
80106da6:	6a 26                	push   $0x26
  jmp alltraps
80106da8:	e9 ef f7 ff ff       	jmp    8010659c <alltraps>
...
80106daf:	6a 27                	push   $0x27
  jmp alltraps
80106db1:	e9 e6 f7 ff ff       	jmp    8010659c <alltraps>
...
80106db8:	6a 28                	push   $0x28
  jmp alltraps
80106dba:	e9 dd f7 ff ff       	jmp    8010659c <alltraps>
...
80106dc1:	6a 29                	push   $0x29
  jmp alltraps
80106dc3:	e9 d4 f7 ff ff       	jmp    8010659c <alltraps>
...
80106dca:	6a 2a                	push   $0x2a
  jmp alltraps
80106dcc:	e9 cb f7 ff ff       	jmp    8010659c <alltraps>
...
80106dd3:	6a 2b                	push   $0x2b
  jmp alltraps
80106dd5:	e9 c2 f7 ff ff       	jmp    8010659c <alltraps>
...
80106ddc:	6a 2c                	push   $0x2c
  jmp alltraps
80106dde:	e9 b9 f7 ff ff       	jmp    8010659c <alltraps>
...
80106de5:	6a 2d                	push   $0x2d
  jmp alltraps
80106de7:	e9 b0 f7 ff ff       	jmp    8010659c <alltraps>
...
80106dee:	6a 2e                	push   $0x2e
  jmp alltraps
80106df0:	e9 a7 f7 ff ff       	jmp    8010659c <alltraps>
...
80106df7:	6a 2f                	push   $0x2f
  jmp alltraps
80106df9:	e9 9e f7 ff ff       	jmp    8010659c <alltraps>
...
80106e00:	6a 30                	push   $0x30
  jmp alltraps
80106e02:	e9 95 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e09:	6a 31                	push   $0x31
  jmp alltraps
80106e0b:	e9 8c f7 ff ff       	jmp    8010659c <alltraps>
...
80106e12:	6a 32                	push   $0x32
  jmp alltraps
80106e14:	e9 83 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e1b:	6a 33                	push   $0x33
  jmp alltraps
80106e1d:	e9 7a f7 ff ff       	jmp    8010659c <alltraps>
...
80106e24:	6a 34                	push   $0x34
  jmp alltraps
80106e26:	e9 71 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e2d:	6a 35                	push   $0x35
  jmp alltraps
80106e2f:	e9 68 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e36:	6a 36                	push   $0x36
  jmp alltraps
80106e38:	e9 5f f7 ff ff       	jmp    8010659c <alltraps>
...
80106e3f:	6a 37                	push   $0x37
  jmp alltraps
80106e41:	e9 56 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e48:	6a 38                	push   $0x38
  jmp alltraps
80106e4a:	e9 4d f7 ff ff       	jmp    8010659c <alltraps>
...
80106e51:	6a 39                	push   $0x39
  jmp alltraps
80106e53:	e9 44 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e5a:	6a 3a                	push   $0x3a
  jmp alltraps
80106e5c:	e9 3b f7 ff ff       	jmp    8010659c <alltraps>
...
80106e63:	6a 3b                	push   $0x3b
  jmp alltraps
80106e65:	e9 32 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e6c:	6a 3c                	push   $0x3c
  jmp alltraps
80106e6e:	e9 29 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e75:	6a 3d                	push   $0x3d
  jmp alltraps
80106e77:	e9 20 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e7e:	6a 3e                	push   $0x3e
  jmp alltraps
80106e80:	e9 17 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e87:	6a 3f                	push   $0x3f
  jmp alltraps
80106e89:	e9 0e f7 ff ff       	jmp    8010659c <alltraps>
...
80106e90:	6a 40                	push   $0x40
  jmp alltraps
80106e92:	e9 05 f7 ff ff       	jmp    8010659c <alltraps>
...
80106e99:	6a 41                	push   $0x41
  jmp alltraps
80106e9b:	e9 fc f6 ff ff       	jmp    8010659c <alltraps>
...
80106ea2:	6a 42                	push   $0x42
  jmp alltraps
80106ea4:	e9 f3 f6 ff ff       	jmp    8010659c <alltraps>
...
80106eab:	6a 43                	push   $0x43
  jmp alltraps
80106ead:	e9 ea f6 ff ff       	jmp    8010659c <alltraps>
...
80106eb4:	6a 44                	push   $0x44
  jmp alltraps
80106eb6:	e9 e1 f6 ff ff       	jmp    8010659c <alltraps>
...
80106ebd:	6a 45                	push   $0x45
  jmp alltraps
80106ebf:	e9 d8 f6 ff ff       	jmp    8010659c <alltraps>
...
80106ec6:	6a 46                	push   $0x46
  jmp alltraps
80106ec8:	e9 cf f6 ff ff       	jmp    8010659c <alltraps>
...
80106ecf:	6a 47                	push   $0x47
  jmp alltraps
80106ed1:	e9 c6 f6 ff ff       	jmp    8010659c <alltraps>
...
80106ed8:	6a 48                	push   $0x48
  jmp alltraps
80106eda:	e9 bd f6 ff ff       	jmp    8010659c <alltraps>
...
80106ee1:	6a 49                	push   $0x49
  jmp alltraps
80106ee3:	e9 b4 f6 ff ff       	jmp    8010659c <alltraps>
...
80106eea:	6a 4a                	push   $0x4a
  jmp alltraps
80106eec:	e9 ab f6 ff ff       	jmp    8010659c <alltraps>
...
80106ef3:	6a 4b                	push   $0x4b
  jmp alltraps
80106ef5:	e9 a2 f6 ff ff       	jmp    8010659c <alltraps>
...
80106efc:	6a 4c                	push   $0x4c
  jmp alltraps
80106efe:	e9 99 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f05:	6a 4d                	push   $0x4d
  jmp alltraps
80106f07:	e9 90 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f0e:	6a 4e                	push   $0x4e
  jmp alltraps
80106f10:	e9 87 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f17:	6a 4f                	push   $0x4f
  jmp alltraps
80106f19:	e9 7e f6 ff ff       	jmp    8010659c <alltraps>
...
80106f20:	6a 50                	push   $0x50
  jmp alltraps
80106f22:	e9 75 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f29:	6a 51                	push   $0x51
  jmp alltraps
80106f2b:	e9 6c f6 ff ff       	jmp    8010659c <alltraps>
...
80106f32:	6a 52                	push   $0x52
  jmp alltraps
80106f34:	e9 63 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f3b:	6a 53                	push   $0x53
  jmp alltraps
80106f3d:	e9 5a f6 ff ff       	jmp    8010659c <alltraps>
...
80106f44:	6a 54                	push   $0x54
  jmp alltraps
80106f46:	e9 51 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f4d:	6a 55                	push   $0x55
  jmp alltraps
80106f4f:	e9 48 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f56:	6a 56                	push   $0x56
  jmp alltraps
80106f58:	e9 3f f6 ff ff       	jmp    8010659c <alltraps>
...
80106f5f:	6a 57                	push   $0x57
  jmp alltraps
80106f61:	e9 36 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f68:	6a 58                	push   $0x58
  jmp alltraps
80106f6a:	e9 2d f6 ff ff       	jmp    8010659c <alltraps>
...
80106f71:	6a 59                	push   $0x59
  jmp alltraps
80106f73:	e9 24 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f7a:	6a 5a                	push   $0x5a
  jmp alltraps
80106f7c:	e9 1b f6 ff ff       	jmp    8010659c <alltraps>
...
80106f83:	6a 5b                	push   $0x5b
  jmp alltraps
80106f85:	e9 12 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f8c:	6a 5c                	push   $0x5c
  jmp alltraps
80106f8e:	e9 09 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f95:	6a 5d                	push   $0x5d
  jmp alltraps
80106f97:	e9 00 f6 ff ff       	jmp    8010659c <alltraps>
...
80106f9e:	6a 5e                	push   $0x5e
  jmp alltraps
80106fa0:	e9 f7 f5 ff ff       	jmp    8010659c <alltraps>
...
80106fa7:	6a 5f                	push   $0x5f
  jmp alltraps
80106fa9:	e9 ee f5 ff ff       	jmp    8010659c <alltraps>
...
80106fb0:	6a 60                	push   $0x60
  jmp alltraps
80106fb2:	e9 e5 f5 ff ff       	jmp    8010659c <alltraps>
...
80106fb9:	6a 61                	push   $0x61
  jmp alltraps
80106fbb:	e9 dc f5 ff ff       	jmp    8010659c <alltraps>
...
80106fc2:	6a 62                	push   $0x62
  jmp alltraps
80106fc4:	e9 d3 f5 ff ff       	jmp    8010659c <alltraps>
...
80106fcb:	6a 63                	push   $0x63
  jmp alltraps
80106fcd:	e9 ca f5 ff ff       	jmp    8010659c <alltraps>
...
80106fd4:	6a 64                	push   $0x64
  jmp alltraps
80106fd6:	e9 c1 f5 ff ff       	jmp    8010659c <alltraps>
...
80106fdd:	6a 65                	push   $0x65
  jmp alltraps
80106fdf:	e9 b8 f5 ff ff       	jmp    8010659c <alltraps>
...
80106fe6:	6a 66                	push   $0x66
  jmp alltraps
80106fe8:	e9 af f5 ff ff       	jmp    8010659c <alltraps>
...
80106fef:	6a 67                	push   $0x67
  jmp alltraps
80106ff1:	e9 a6 f5 ff ff       	jmp    8010659c <alltraps>
...
80106ff8:	6a 68                	push   $0x68
  jmp alltraps
80106ffa:	e9 9d f5 ff ff       	jmp    8010659c <alltraps>
...
80107001:	6a 69                	push   $0x69
  jmp alltraps
80107003:	e9 94 f5 ff ff       	jmp    8010659c <alltraps>
...
8010700a:	6a 6a                	push   $0x6a
  jmp alltraps
8010700c:	e9 8b f5 ff ff       	jmp    8010659c <alltraps>
...
80107013:	6a 6b                	push   $0x6b
  jmp alltraps
80107015:	e9 82 f5 ff ff       	jmp    8010659c <alltraps>
...
8010701c:	6a 6c                	push   $0x6c
  jmp alltraps
8010701e:	e9 79 f5 ff ff       	jmp    8010659c <alltraps>
...
80107025:	6a 6d                	push   $0x6d
  jmp alltraps
80107027:	e9 70 f5 ff ff       	jmp    8010659c <alltraps>
...
8010702e:	6a 6e                	push   $0x6e
  jmp alltraps
80107030:	e9 67 f5 ff ff       	jmp    8010659c <alltraps>
...
80107037:	6a 6f                	push   $0x6f
  jmp alltraps
80107039:	e9 5e f5 ff ff       	jmp    8010659c <alltraps>
...
80107040:	6a 70                	push   $0x70
  jmp alltraps
80107042:	e9 55 f5 ff ff       	jmp    8010659c <alltraps>
...
80107049:	6a 71                	push   $0x71
  jmp alltraps
8010704b:	e9 4c f5 ff ff       	jmp    8010659c <alltraps>
...
80107052:	6a 72                	push   $0x72
  jmp alltraps
80107054:	e9 43 f5 ff ff       	jmp    8010659c <alltraps>
...
8010705b:	6a 73                	push   $0x73
  jmp alltraps
8010705d:	e9 3a f5 ff ff       	jmp    8010659c <alltraps>
...
80107064:	6a 74                	push   $0x74
  jmp alltraps
80107066:	e9 31 f5 ff ff       	jmp    8010659c <alltraps>
...
8010706d:	6a 75                	push   $0x75
  jmp alltraps
8010706f:	e9 28 f5 ff ff       	jmp    8010659c <alltraps>
...
80107076:	6a 76                	push   $0x76
  jmp alltraps
80107078:	e9 1f f5 ff ff       	jmp    8010659c <alltraps>
...
8010707f:	6a 77                	push   $0x77
  jmp alltraps
80107081:	e9 16 f5 ff ff       	jmp    8010659c <alltraps>
...
80107088:	6a 78                	push   $0x78
  jmp alltraps
8010708a:	e9 0d f5 ff ff       	jmp    8010659c <alltraps>
...
80107091:	6a 79                	push   $0x79
  jmp alltraps
80107093:	e9 04 f5 ff ff       	jmp    8010659c <alltraps>
...
8010709a:	6a 7a                	push   $0x7a
  jmp alltraps
8010709c:	e9 fb f4 ff ff       	jmp    8010659c <alltraps>
...
801070a3:	6a 7b                	push   $0x7b
  jmp alltraps
801070a5:	e9 f2 f4 ff ff       	jmp    8010659c <alltraps>
...
801070ac:	6a 7c                	push   $0x7c
  jmp alltraps
801070ae:	e9 e9 f4 ff ff       	jmp    8010659c <alltraps>
...
801070b5:	6a 7d                	push   $0x7d
  jmp alltraps
801070b7:	e9 e0 f4 ff ff       	jmp    8010659c <alltraps>
...
801070be:	6a 7e                	push   $0x7e
  jmp alltraps
801070c0:	e9 d7 f4 ff ff       	jmp    8010659c <alltraps>
...
801070c7:	6a 7f                	push   $0x7f
  jmp alltraps
801070c9:	e9 ce f4 ff ff       	jmp    8010659c <alltraps>
...
801070d0:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801070d5:	e9 c2 f4 ff ff       	jmp    8010659c <alltraps>
...
801070dc:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801070e1:	e9 b6 f4 ff ff       	jmp    8010659c <alltraps>
...
801070e8:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801070ed:	e9 aa f4 ff ff       	jmp    8010659c <alltraps>
...
801070f4:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801070f9:	e9 9e f4 ff ff       	jmp    8010659c <alltraps>
...
80107100:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107105:	e9 92 f4 ff ff       	jmp    8010659c <alltraps>
...
8010710c:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107111:	e9 86 f4 ff ff       	jmp    8010659c <alltraps>
...
80107118:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010711d:	e9 7a f4 ff ff       	jmp    8010659c <alltraps>
...
80107124:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107129:	e9 6e f4 ff ff       	jmp    8010659c <alltraps>
...
80107130:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107135:	e9 62 f4 ff ff       	jmp    8010659c <alltraps>
...
8010713c:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107141:	e9 56 f4 ff ff       	jmp    8010659c <alltraps>
...
80107148:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010714d:	e9 4a f4 ff ff       	jmp    8010659c <alltraps>
...
80107154:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107159:	e9 3e f4 ff ff       	jmp    8010659c <alltraps>
...
80107160:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107165:	e9 32 f4 ff ff       	jmp    8010659c <alltraps>
...
8010716c:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107171:	e9 26 f4 ff ff       	jmp    8010659c <alltraps>
...
80107178:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010717d:	e9 1a f4 ff ff       	jmp    8010659c <alltraps>
...
80107184:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107189:	e9 0e f4 ff ff       	jmp    8010659c <alltraps>
...
80107190:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107195:	e9 02 f4 ff ff       	jmp    8010659c <alltraps>
...
8010719c:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801071a1:	e9 f6 f3 ff ff       	jmp    8010659c <alltraps>
...
801071a8:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801071ad:	e9 ea f3 ff ff       	jmp    8010659c <alltraps>
...
801071b4:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801071b9:	e9 de f3 ff ff       	jmp    8010659c <alltraps>
...
801071c0:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801071c5:	e9 d2 f3 ff ff       	jmp    8010659c <alltraps>
...
801071cc:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801071d1:	e9 c6 f3 ff ff       	jmp    8010659c <alltraps>
...
801071d8:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801071dd:	e9 ba f3 ff ff       	jmp    8010659c <alltraps>
...
801071e4:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801071e9:	e9 ae f3 ff ff       	jmp    8010659c <alltraps>
...
801071f0:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801071f5:	e9 a2 f3 ff ff       	jmp    8010659c <alltraps>
...
801071fc:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107201:	e9 96 f3 ff ff       	jmp    8010659c <alltraps>
...
80107208:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010720d:	e9 8a f3 ff ff       	jmp    8010659c <alltraps>
...
80107214:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107219:	e9 7e f3 ff ff       	jmp    8010659c <alltraps>
...
80107220:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107225:	e9 72 f3 ff ff       	jmp    8010659c <alltraps>
...
8010722c:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107231:	e9 66 f3 ff ff       	jmp    8010659c <alltraps>
...
80107238:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010723d:	e9 5a f3 ff ff       	jmp    8010659c <alltraps>
...
80107244:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107249:	e9 4e f3 ff ff       	jmp    8010659c <alltraps>
...
80107250:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107255:	e9 42 f3 ff ff       	jmp    8010659c <alltraps>
...
8010725c:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107261:	e9 36 f3 ff ff       	jmp    8010659c <alltraps>
...
80107268:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010726d:	e9 2a f3 ff ff       	jmp    8010659c <alltraps>
...
80107274:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107279:	e9 1e f3 ff ff       	jmp    8010659c <alltraps>
...
80107280:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107285:	e9 12 f3 ff ff       	jmp    8010659c <alltraps>
...
8010728c:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107291:	e9 06 f3 ff ff       	jmp    8010659c <alltraps>
...
80107298:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010729d:	e9 fa f2 ff ff       	jmp    8010659c <alltraps>
...
801072a4:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801072a9:	e9 ee f2 ff ff       	jmp    8010659c <alltraps>
...
801072b0:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801072b5:	e9 e2 f2 ff ff       	jmp    8010659c <alltraps>
...
801072bc:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801072c1:	e9 d6 f2 ff ff       	jmp    8010659c <alltraps>
...
801072c8:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801072cd:	e9 ca f2 ff ff       	jmp    8010659c <alltraps>
...
801072d4:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801072d9:	e9 be f2 ff ff       	jmp    8010659c <alltraps>
...
801072e0:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801072e5:	e9 b2 f2 ff ff       	jmp    8010659c <alltraps>
...
801072ec:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801072f1:	e9 a6 f2 ff ff       	jmp    8010659c <alltraps>
...
801072f8:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801072fd:	e9 9a f2 ff ff       	jmp    8010659c <alltraps>
...
80107304:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107309:	e9 8e f2 ff ff       	jmp    8010659c <alltraps>
...
80107310:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107315:	e9 82 f2 ff ff       	jmp    8010659c <alltraps>
...
8010731c:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107321:	e9 76 f2 ff ff       	jmp    8010659c <alltraps>
...
80107328:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010732d:	e9 6a f2 ff ff       	jmp    8010659c <alltraps>
...
80107334:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107339:	e9 5e f2 ff ff       	jmp    8010659c <alltraps>
...
80107340:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107345:	e9 52 f2 ff ff       	jmp    8010659c <alltraps>
...
8010734c:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107351:	e9 46 f2 ff ff       	jmp    8010659c <alltraps>
...
80107358:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010735d:	e9 3a f2 ff ff       	jmp    8010659c <alltraps>
...
80107364:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107369:	e9 2e f2 ff ff       	jmp    8010659c <alltraps>
...
80107370:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107375:	e9 22 f2 ff ff       	jmp    8010659c <alltraps>
...
8010737c:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107381:	e9 16 f2 ff ff       	jmp    8010659c <alltraps>
...
80107388:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010738d:	e9 0a f2 ff ff       	jmp    8010659c <alltraps>
...
80107394:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107399:	e9 fe f1 ff ff       	jmp    8010659c <alltraps>
...
801073a0:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801073a5:	e9 f2 f1 ff ff       	jmp    8010659c <alltraps>
...
801073ac:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801073b1:	e9 e6 f1 ff ff       	jmp    8010659c <alltraps>
...
801073b8:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801073bd:	e9 da f1 ff ff       	jmp    8010659c <alltraps>
...
801073c4:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801073c9:	e9 ce f1 ff ff       	jmp    8010659c <alltraps>
...
801073d0:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801073d5:	e9 c2 f1 ff ff       	jmp    8010659c <alltraps>
...
801073dc:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801073e1:	e9 b6 f1 ff ff       	jmp    8010659c <alltraps>
...
801073e8:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801073ed:	e9 aa f1 ff ff       	jmp    8010659c <alltraps>
...
801073f4:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801073f9:	e9 9e f1 ff ff       	jmp    8010659c <alltraps>
...
80107400:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107405:	e9 92 f1 ff ff       	jmp    8010659c <alltraps>
...
8010740c:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107411:	e9 86 f1 ff ff       	jmp    8010659c <alltraps>
...
80107418:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010741d:	e9 7a f1 ff ff       	jmp    8010659c <alltraps>
...
80107424:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107429:	e9 6e f1 ff ff       	jmp    8010659c <alltraps>
...
80107430:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107435:	e9 62 f1 ff ff       	jmp    8010659c <alltraps>
...
8010743c:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107441:	e9 56 f1 ff ff       	jmp    8010659c <alltraps>
...
80107448:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010744d:	e9 4a f1 ff ff       	jmp    8010659c <alltraps>
...
80107454:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107459:	e9 3e f1 ff ff       	jmp    8010659c <alltraps>
...
80107460:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107465:	e9 32 f1 ff ff       	jmp    8010659c <alltraps>
...
8010746c:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107471:	e9 26 f1 ff ff       	jmp    8010659c <alltraps>
...
80107478:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010747d:	e9 1a f1 ff ff       	jmp    8010659c <alltraps>
...
80107484:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107489:	e9 0e f1 ff ff       	jmp    8010659c <alltraps>
...
80107490:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107495:	e9 02 f1 ff ff       	jmp    8010659c <alltraps>
...
8010749c:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801074a1:	e9 f6 f0 ff ff       	jmp    8010659c <alltraps>
...
801074a8:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801074ad:	e9 ea f0 ff ff       	jmp    8010659c <alltraps>
...
801074b4:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801074b9:	e9 de f0 ff ff       	jmp    8010659c <alltraps>
...
801074c0:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801074c5:	e9 d2 f0 ff ff       	jmp    8010659c <alltraps>
...
801074cc:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801074d1:	e9 c6 f0 ff ff       	jmp    8010659c <alltraps>
...
801074d8:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801074dd:	e9 ba f0 ff ff       	jmp    8010659c <alltraps>
...
801074e4:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801074e9:	e9 ae f0 ff ff       	jmp    8010659c <alltraps>
...
801074f0:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801074f5:	e9 a2 f0 ff ff       	jmp    8010659c <alltraps>
...
801074fc:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107501:	e9 96 f0 ff ff       	jmp    8010659c <alltraps>
...
80107508:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010750d:	e9 8a f0 ff ff       	jmp    8010659c <alltraps>
...
80107514:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107519:	e9 7e f0 ff ff       	jmp    8010659c <alltraps>
...
80107520:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107525:	e9 72 f0 ff ff       	jmp    8010659c <alltraps>
...
8010752c:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107531:	e9 66 f0 ff ff       	jmp    8010659c <alltraps>
...
80107538:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010753d:	e9 5a f0 ff ff       	jmp    8010659c <alltraps>
...
80107544:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107549:	e9 4e f0 ff ff       	jmp    8010659c <alltraps>
...
80107550:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107555:	e9 42 f0 ff ff       	jmp    8010659c <alltraps>
...
8010755c:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107561:	e9 36 f0 ff ff       	jmp    8010659c <alltraps>
...
80107568:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
8010756d:	e9 2a f0 ff ff       	jmp    8010659c <alltraps>
...
80107574:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107579:	e9 1e f0 ff ff       	jmp    8010659c <alltraps>
...
80107580:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107585:	e9 12 f0 ff ff       	jmp    8010659c <alltraps>
...
8010758c:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107591:	e9 06 f0 ff ff       	jmp    8010659c <alltraps>
...
80107598:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010759d:	e9 fa ef ff ff       	jmp    8010659c <alltraps>
...
801075a4:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801075a9:	e9 ee ef ff ff       	jmp    8010659c <alltraps>
...
801075b0:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801075b5:	e9 e2 ef ff ff       	jmp    8010659c <alltraps>
...
801075bc:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801075c1:	e9 d6 ef ff ff       	jmp    8010659c <alltraps>
...
801075c8:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801075cd:	e9 ca ef ff ff       	jmp    8010659c <alltraps>
...
801075d4:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801075d9:	e9 be ef ff ff       	jmp    8010659c <alltraps>
...
801075e0:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801075e5:	e9 b2 ef ff ff       	jmp    8010659c <alltraps>
...
801075ec:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801075f1:	e9 a6 ef ff ff       	jmp    8010659c <alltraps>
...
801075f8:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801075fd:	e9 9a ef ff ff       	jmp    8010659c <alltraps>
...
80107604:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107609:	e9 8e ef ff ff       	jmp    8010659c <alltraps>
...
80107610:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107615:	e9 82 ef ff ff       	jmp    8010659c <alltraps>
...
8010761c:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107621:	e9 76 ef ff ff       	jmp    8010659c <alltraps>
...
80107628:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010762d:	e9 6a ef ff ff       	jmp    8010659c <alltraps>
...
80107634:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107639:	e9 5e ef ff ff       	jmp    8010659c <alltraps>
...
80107640:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107645:	e9 52 ef ff ff       	jmp    8010659c <alltraps>
...
8010764c:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107651:	e9 46 ef ff ff       	jmp    8010659c <alltraps>
...
80107658:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010765d:	e9 3a ef ff ff       	jmp    8010659c <alltraps>
...
80107664:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107669:	e9 2e ef ff ff       	jmp    8010659c <alltraps>
...
80107670:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107675:	e9 22 ef ff ff       	jmp    8010659c <alltraps>
...
8010767c:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107681:	e9 16 ef ff ff       	jmp    8010659c <alltraps>
...
80107688:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010768d:	e9 0a ef ff ff       	jmp    8010659c <alltraps>
...
80107694:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107699:	e9 fe ee ff ff       	jmp    8010659c <alltraps>
...
801076a0:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801076a5:	e9 f2 ee ff ff       	jmp    8010659c <alltraps>
...
801076ac:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801076b1:	e9 e6 ee ff ff       	jmp    8010659c <alltraps>
...
801076b8:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801076bd:	e9 da ee ff ff       	jmp    8010659c <alltraps>
...
801076c4:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801076c9:	e9 ce ee ff ff       	jmp    8010659c <alltraps>
	...
...
80107702:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107706:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010770a:	0f 00 d8             	ltr    %ax
}
8010770d:	c9                   	leave  
8010770e:	c3                   	ret    
...
loadgs(ushort v)
{
8010770f:	55                   	push   %ebp
80107710:	89 e5                	mov    %esp,%ebp
80107712:	83 ec 04             	sub    $0x4,%esp
80107715:	8b 45 08             	mov    0x8(%ebp),%eax
80107718:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
8010771c:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107720:	8e e8                	mov    %eax,%gs
}
80107722:	c9                   	leave  
80107723:	c3                   	ret    
...
80107742:	05 00 00 00 80       	add    $0x80000000,%eax
80107747:	5d                   	pop    %ebp
80107748:	c3                   	ret    
...
8010774d:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107750:	e8 6e b7 ff ff       	call   80102ec3 <cpunum>
80107755:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010775b:	05 60 23 11 80       	add    $0x80112360,%eax
80107760:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107763:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107766:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
8010776c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010776f:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107775:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107778:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
8010777c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010777f:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107783:	83 e2 f0             	and    $0xfffffff0,%edx
80107786:	83 ca 0a             	or     $0xa,%edx
...
80107889:	83 e2 ef             	and    $0xffffffef,%edx
...
801078ce:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801078d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078d8:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801078df:	ff ff 
801078e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078e4:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801078eb:	00 00 
801078ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078f0:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
801078f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078fa:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107901:	83 e2 f0             	and    $0xfffffff0,%edx
80107904:	83 ca 0a             	or     $0xa,%edx
...
8010793d:	83 ca 80             	or     $0xffffff80,%edx
...
80107963:	83 e2 ef             	and    $0xffffffef,%edx
...
80107976:	83 e2 df             	and    $0xffffffdf,%edx
...
801079a8:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801079af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079b2:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801079b9:	ff ff 
801079bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079be:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801079c5:	00 00 
801079c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ca:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801079d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079d4:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801079db:	83 e2 f0             	and    $0xfffffff0,%edx
801079de:	83 ca 02             	or     $0x2,%edx
801079e1:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801079e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079ea:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801079f1:	83 ca 10             	or     $0x10,%edx
...
80107a17:	83 ca 80             	or     $0xffffff80,%edx
80107a1a:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107a20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a23:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107a2a:	83 ca 0f             	or     $0xf,%edx
80107a2d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
80107a82:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107a89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a8c:	05 b4 00 00 00       	add    $0xb4,%eax
80107a91:	89 c3                	mov    %eax,%ebx
80107a93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a96:	05 b4 00 00 00       	add    $0xb4,%eax
80107a9b:	c1 e8 10             	shr    $0x10,%eax
80107a9e:	89 c1                	mov    %eax,%ecx
80107aa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aa3:	05 b4 00 00 00       	add    $0xb4,%eax
80107aa8:	c1 e8 18             	shr    $0x18,%eax
80107aab:	89 c2                	mov    %eax,%edx
80107aad:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab0:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107ab7:	00 00 
80107ab9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107abc:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107ac3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ac6:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107acc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107acf:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107ad6:	83 e1 f0             	and    $0xfffffff0,%ecx
80107ad9:	83 c9 02             	or     $0x2,%ecx
80107adc:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107ae2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ae5:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107aec:	83 c9 10             	or     $0x10,%ecx
80107aef:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107af8:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107aff:	83 e1 9f             	and    $0xffffff9f,%ecx
80107b02:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b0b:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b12:	83 c9 80             	or     $0xffffff80,%ecx
80107b15:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b1e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b25:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b28:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b31:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b38:	83 e1 ef             	and    $0xffffffef,%ecx
80107b3b:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b41:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b44:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b4b:	83 e1 df             	and    $0xffffffdf,%ecx
80107b4e:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b57:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b5e:	83 c9 40             	or     $0x40,%ecx
80107b61:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b6a:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b71:	83 c9 80             	or     $0xffffff80,%ecx
80107b74:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107b7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b7d:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107b83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b86:	83 c0 70             	add    $0x70,%eax
80107b89:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107b90:	00 
80107b91:	89 04 24             	mov    %eax,(%esp)
80107b94:	e8 37 fb ff ff       	call   801076d0 <lgdt>
  loadgs(SEG_KCPU << 3);
80107b99:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107ba0:	e8 6a fb ff ff       	call   8010770f <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107ba5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ba8:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107bae:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107bb5:	00 00 00 00 
}
80107bb9:	83 c4 24             	add    $0x24,%esp
80107bbc:	5b                   	pop    %ebx
80107bbd:	5d                   	pop    %ebp
80107bbe:	c3                   	ret    
...
80107bc2:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107bc5:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bc8:	c1 e8 16             	shr    $0x16,%eax
80107bcb:	c1 e0 02             	shl    $0x2,%eax
80107bce:	03 45 08             	add    0x8(%ebp),%eax
80107bd1:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107bd4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bd7:	8b 00                	mov    (%eax),%eax
80107bd9:	83 e0 01             	and    $0x1,%eax
80107bdc:	84 c0                	test   %al,%al
80107bde:	74 17                	je     80107bf7 <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107be0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107be3:	8b 00                	mov    (%eax),%eax
80107be5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107bea:	89 04 24             	mov    %eax,(%esp)
80107bed:	e8 4a fb ff ff       	call   8010773c <p2v>
80107bf2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107bf5:	eb 4b                	jmp    80107c42 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107bf7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107bfb:	74 0e                	je     80107c0b <walkpgdir+0x4c>
80107bfd:	e8 09 af ff ff       	call   80102b0b <kalloc>
80107c02:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c05:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107c09:	75 07                	jne    80107c12 <walkpgdir+0x53>
      return 0;
80107c0b:	b8 00 00 00 00       	mov    $0x0,%eax
80107c10:	eb 41                	jmp    80107c53 <walkpgdir+0x94>
...
80107c28:	e8 bd d4 ff ff       	call   801050ea <memset>
...
80107c33:	e8 f7 fa ff ff       	call   8010772f <v2p>
80107c38:	89 c2                	mov    %eax,%edx
80107c3a:	83 ca 07             	or     $0x7,%edx
80107c3d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c40:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107c42:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c45:	c1 e8 0c             	shr    $0xc,%eax
80107c48:	25 ff 03 00 00       	and    $0x3ff,%eax
80107c4d:	c1 e0 02             	shl    $0x2,%eax
80107c50:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107c53:	c9                   	leave  
80107c54:	c3                   	ret    
...
80107c58:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80107c5b:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c5e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c63:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107c66:	8b 45 0c             	mov    0xc(%ebp),%eax
80107c69:	03 45 10             	add    0x10(%ebp),%eax
80107c6c:	83 e8 01             	sub    $0x1,%eax
80107c6f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c74:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107c77:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107c7e:	00 
80107c7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c82:	89 44 24 04          	mov    %eax,0x4(%esp)
80107c86:	8b 45 08             	mov    0x8(%ebp),%eax
80107c89:	89 04 24             	mov    %eax,(%esp)
80107c8c:	e8 2e ff ff ff       	call   80107bbf <walkpgdir>
80107c91:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107c94:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107c98:	75 07                	jne    80107ca1 <mappages+0x4c>
      return -1;
80107c9a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107c9f:	eb 46                	jmp    80107ce7 <mappages+0x92>
    if(*pte & PTE_P)
80107ca1:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107ca4:	8b 00                	mov    (%eax),%eax
80107ca6:	83 e0 01             	and    $0x1,%eax
80107ca9:	84 c0                	test   %al,%al
80107cab:	74 0c                	je     80107cb9 <mappages+0x64>
      panic("remap");
80107cad:	c7 04 24 68 8b 10 80 	movl   $0x80108b68,(%esp)
80107cb4:	e8 84 88 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107cb9:	8b 45 18             	mov    0x18(%ebp),%eax
80107cbc:	0b 45 14             	or     0x14(%ebp),%eax
80107cbf:	89 c2                	mov    %eax,%edx
80107cc1:	83 ca 01             	or     $0x1,%edx
80107cc4:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cc7:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107cc9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ccc:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107ccf:	74 10                	je     80107ce1 <mappages+0x8c>
      break;
    a += PGSIZE;
80107cd1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107cd8:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107cdf:	eb 96                	jmp    80107c77 <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107ced:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107cf0:	e8 16 ae ff ff       	call   80102b0b <kalloc>
80107cf5:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107cf8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107cfc:	75 0a                	jne    80107d08 <setupkvm+0x1f>
    return 0;
80107cfe:	b8 00 00 00 00       	mov    $0x0,%eax
80107d03:	e9 98 00 00 00       	jmp    80107da0 <setupkvm+0xb7>
...
80107d1e:	e8 c7 d3 ff ff       	call   801050ea <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107d23:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107d2a:	e8 0d fa ff ff       	call   8010773c <p2v>
80107d2f:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107d34:	76 0c                	jbe    80107d42 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107d36:	c7 04 24 6e 8b 10 80 	movl   $0x80108b6e,(%esp)
80107d3d:	e8 fb 87 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d42:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107d49:	eb 49                	jmp    80107d94 <setupkvm+0xab>
...
80107d4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107d4e:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107d51:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107d54:	8b 50 04             	mov    0x4(%eax),%edx
80107d57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d5a:	8b 58 08             	mov    0x8(%eax),%ebx
80107d5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d60:	8b 40 04             	mov    0x4(%eax),%eax
80107d63:	29 c3                	sub    %eax,%ebx
80107d65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d68:	8b 00                	mov    (%eax),%eax
80107d6a:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107d6e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d72:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107d76:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d7a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d7d:	89 04 24             	mov    %eax,(%esp)
80107d80:	e8 d0 fe ff ff       	call   80107c55 <mappages>
80107d85:	85 c0                	test   %eax,%eax
80107d87:	79 07                	jns    80107d90 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107d89:	b8 00 00 00 00       	mov    $0x0,%eax
80107d8e:	eb 10                	jmp    80107da0 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d90:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107d94:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107d9b:	72 ae                	jb     80107d4b <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107da0:	83 c4 34             	add    $0x34,%esp
80107da3:	5b                   	pop    %ebx
80107da4:	5d                   	pop    %ebp
80107da5:	c3                   	ret    
...
80107da9:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107dac:	e8 38 ff ff ff       	call   80107ce9 <setupkvm>
80107db1:	a3 38 51 12 80       	mov    %eax,0x80125138
  switchkvm();
80107db6:	e8 02 00 00 00       	call   80107dbd <switchkvm>
}
80107dbb:	c9                   	leave  
80107dbc:	c3                   	ret    
...
80107dc3:	a1 38 51 12 80       	mov    0x80125138,%eax
80107dc8:	89 04 24             	mov    %eax,(%esp)
80107dcb:	e8 5f f9 ff ff       	call   8010772f <v2p>
80107dd0:	89 04 24             	mov    %eax,(%esp)
80107dd3:	e8 4c f9 ff ff       	call   80107724 <lcr3>
}
80107dd8:	c9                   	leave  
80107dd9:	c3                   	ret    
...
80107dde:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107de1:	e8 fd d1 ff ff       	call   80104fe3 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107de6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
...
80107e02:	c1 ea 10             	shr    $0x10,%edx
80107e05:	89 d1                	mov    %edx,%ecx
80107e07:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e0e:	83 c2 08             	add    $0x8,%edx
80107e11:	c1 ea 18             	shr    $0x18,%edx
80107e14:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107e1b:	67 00 
80107e1d:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107e24:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107e2a:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e31:	83 e1 f0             	and    $0xfffffff0,%ecx
80107e34:	83 c9 09             	or     $0x9,%ecx
80107e37:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e3d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e44:	83 c9 10             	or     $0x10,%ecx
80107e47:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e4d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e54:	83 e1 9f             	and    $0xffffff9f,%ecx
80107e57:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e5d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e64:	83 c9 80             	or     $0xffffff80,%ecx
80107e67:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e6d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e74:	83 e1 f0             	and    $0xfffffff0,%ecx
80107e77:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e7d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e84:	83 e1 ef             	and    $0xffffffef,%ecx
80107e87:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e8d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107e94:	83 e1 df             	and    $0xffffffdf,%ecx
80107e97:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107e9d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ea4:	83 c9 40             	or     $0x40,%ecx
80107ea7:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ead:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eb4:	83 e1 7f             	and    $0x7f,%ecx
80107eb7:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ebd:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
...
80107ed3:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107ed9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107edf:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107ee5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107eeb:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107ef2:	8b 52 08             	mov    0x8(%edx),%edx
80107ef5:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107efb:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107efe:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107f05:	e8 ef f7 ff ff       	call   801076f9 <ltr>
  if(p->pgdir == 0)
80107f0a:	8b 45 08             	mov    0x8(%ebp),%eax
80107f0d:	8b 40 04             	mov    0x4(%eax),%eax
80107f10:	85 c0                	test   %eax,%eax
80107f12:	75 0c                	jne    80107f20 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107f14:	c7 04 24 7f 8b 10 80 	movl   $0x80108b7f,(%esp)
80107f1b:	e8 1d 86 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107f20:	8b 45 08             	mov    0x8(%ebp),%eax
80107f23:	8b 40 04             	mov    0x4(%eax),%eax
80107f26:	89 04 24             	mov    %eax,(%esp)
80107f29:	e8 01 f8 ff ff       	call   8010772f <v2p>
80107f2e:	89 04 24             	mov    %eax,(%esp)
80107f31:	e8 ee f7 ff ff       	call   80107724 <lcr3>
  popcli();
80107f36:	e8 f0 d0 ff ff       	call   8010502b <popcli>
}
80107f3b:	83 c4 14             	add    $0x14,%esp
80107f3e:	5b                   	pop    %ebx
80107f3f:	5d                   	pop    %ebp
80107f40:	c3                   	ret    
...
80107f44:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107f47:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107f4e:	76 0c                	jbe    80107f5c <inituvm+0x1b>
    panic("inituvm: more than a page");
80107f50:	c7 04 24 93 8b 10 80 	movl   $0x80108b93,(%esp)
80107f57:	e8 e1 85 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107f5c:	e8 aa ab ff ff       	call   80102b0b <kalloc>
80107f61:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80107f64:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f6b:	00 
80107f6c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107f73:	00 
80107f74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f77:	89 04 24             	mov    %eax,(%esp)
80107f7a:	e8 6b d1 ff ff       	call   801050ea <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107f7f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f82:	89 04 24             	mov    %eax,(%esp)
80107f85:	e8 a5 f7 ff ff       	call   8010772f <v2p>
80107f8a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107f91:	00 
80107f92:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107f96:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107f9d:	00 
80107f9e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107fa5:	00 
80107fa6:	8b 45 08             	mov    0x8(%ebp),%eax
80107fa9:	89 04 24             	mov    %eax,(%esp)
80107fac:	e8 a4 fc ff ff       	call   80107c55 <mappages>
  memmove(mem, init, sz);
80107fb1:	8b 45 10             	mov    0x10(%ebp),%eax
80107fb4:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107fc5:	e8 f3 d1 ff ff       	call   801051bd <memmove>
}
80107fca:	c9                   	leave  
80107fcb:	c3                   	ret    
...
80107fd0:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107fd3:	8b 45 0c             	mov    0xc(%ebp),%eax
80107fd6:	25 ff 0f 00 00       	and    $0xfff,%eax
80107fdb:	85 c0                	test   %eax,%eax
80107fdd:	74 0c                	je     80107feb <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107fdf:	c7 04 24 b0 8b 10 80 	movl   $0x80108bb0,(%esp)
80107fe6:	e8 52 85 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107feb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107ff2:	e9 ad 00 00 00       	jmp    801080a4 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107ff7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ffa:	8b 55 0c             	mov    0xc(%ebp),%edx
80107ffd:	01 d0                	add    %edx,%eax
80107fff:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108006:	00 
80108007:	89 44 24 04          	mov    %eax,0x4(%esp)
8010800b:	8b 45 08             	mov    0x8(%ebp),%eax
8010800e:	89 04 24             	mov    %eax,(%esp)
80108011:	e8 a9 fb ff ff       	call   80107bbf <walkpgdir>
80108016:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108019:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010801d:	75 0c                	jne    8010802b <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010801f:	c7 04 24 d3 8b 10 80 	movl   $0x80108bd3,(%esp)
80108026:	e8 12 85 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
8010802b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010802e:	8b 00                	mov    (%eax),%eax
80108030:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108035:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108038:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803b:	8b 55 18             	mov    0x18(%ebp),%edx
8010803e:	89 d1                	mov    %edx,%ecx
80108040:	29 c1                	sub    %eax,%ecx
80108042:	89 c8                	mov    %ecx,%eax
80108044:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108049:	77 11                	ja     8010805c <loaduvm+0x90>
      n = sz - i;
8010804b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010804e:	8b 55 18             	mov    0x18(%ebp),%edx
80108051:	89 d1                	mov    %edx,%ecx
80108053:	29 c1                	sub    %eax,%ecx
80108055:	89 c8                	mov    %ecx,%eax
80108057:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010805a:	eb 07                	jmp    80108063 <loaduvm+0x97>
    else
      n = PGSIZE;
8010805c:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108063:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108066:	8b 55 14             	mov    0x14(%ebp),%edx
80108069:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
8010806c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010806f:	89 04 24             	mov    %eax,(%esp)
80108072:	e8 c5 f6 ff ff       	call   8010773c <p2v>
...
8010808c:	e8 d9 9c ff ff       	call   80101d6a <readi>
80108091:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108094:	74 07                	je     8010809d <loaduvm+0xd1>
      return -1;
80108096:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010809b:	eb 18                	jmp    801080b5 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
801080a7:	3b 45 18             	cmp    0x18(%ebp),%eax
801080aa:	0f 82 47 ff ff ff    	jb     80107ff7 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
  ...
  return 0;
801080b0:	b8 00 00 00 00       	mov    $0x0,%eax
}
801080b5:	83 c4 24             	add    $0x24,%esp
801080b8:	5b                   	pop    %ebx
801080b9:	5d                   	pop    %ebp
801080ba:	c3                   	ret    
...
801080be:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801080c6:	79 0a                	jns    801080d2 <allocuvm+0x17>
    return 0;
801080c8:	b8 00 00 00 00       	mov    $0x0,%eax
801080cd:	e9 c1 00 00 00       	jmp    80108193 <allocuvm+0xd8>
  if(newsz < oldsz)
801080d2:	8b 45 10             	mov    0x10(%ebp),%eax
801080d5:	3b 45 0c             	cmp    0xc(%ebp),%eax
801080d8:	73 08                	jae    801080e2 <allocuvm+0x27>
    return oldsz;
801080da:	8b 45 0c             	mov    0xc(%ebp),%eax
801080dd:	e9 b1 00 00 00       	jmp    80108193 <allocuvm+0xd8>
...
801080f2:	e9 8d 00 00 00       	jmp    80108184 <allocuvm+0xc9>
    mem = kalloc();
801080f7:	e8 0f aa ff ff       	call   80102b0b <kalloc>
801080fc:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
801080ff:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108103:	75 2c                	jne    80108131 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108105:	c7 04 24 f1 8b 10 80 	movl   $0x80108bf1,(%esp)
8010810c:	e8 90 82 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108111:	8b 45 0c             	mov    0xc(%ebp),%eax
80108114:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108125:	e8 6b 00 00 00       	call   80108195 <deallocuvm>
      return 0;
8010812a:	b8 00 00 00 00       	mov    $0x0,%eax
8010812f:	eb 62                	jmp    80108193 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108131:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108138:	00 
80108139:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108140:	00 
80108141:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108144:	89 04 24             	mov    %eax,(%esp)
80108147:	e8 9e cf ff ff       	call   801050ea <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010814c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010814f:	89 04 24             	mov    %eax,(%esp)
80108152:	e8 d8 f5 ff ff       	call   8010772f <v2p>
80108157:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010815a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108161:	00 
80108162:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108166:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010816d:	00 
8010816e:	89 54 24 04          	mov    %edx,0x4(%esp)
80108172:	8b 45 08             	mov    0x8(%ebp),%eax
80108175:	89 04 24             	mov    %eax,(%esp)
80108178:	e8 d8 fa ff ff       	call   80107c55 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108187:	3b 45 10             	cmp    0x10(%ebp),%eax
8010818a:	0f 82 67 ff ff ff    	jb     801080f7 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80108198:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
8010819b:	8b 45 10             	mov    0x10(%ebp),%eax
8010819e:	3b 45 0c             	cmp    0xc(%ebp),%eax
801081a1:	72 08                	jb     801081ab <deallocuvm+0x16>
    return oldsz;
801081a3:	8b 45 0c             	mov    0xc(%ebp),%eax
801081a6:	e9 a4 00 00 00       	jmp    8010824f <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801081ab:	8b 45 10             	mov    0x10(%ebp),%eax
801081ae:	05 ff 0f 00 00       	add    $0xfff,%eax
801081b3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801081b8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801081bb:	e9 80 00 00 00       	jmp    80108240 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801081c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081c3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081ca:	00 
801081cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801081cf:	8b 45 08             	mov    0x8(%ebp),%eax
801081d2:	89 04 24             	mov    %eax,(%esp)
801081d5:	e8 e5 f9 ff ff       	call   80107bbf <walkpgdir>
801081da:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801081dd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081e1:	75 09                	jne    801081ec <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801081e3:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801081ea:	eb 4d                	jmp    80108239 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801081ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081ef:	8b 00                	mov    (%eax),%eax
801081f1:	83 e0 01             	and    $0x1,%eax
801081f4:	84 c0                	test   %al,%al
801081f6:	74 41                	je     80108239 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80108209:	75 0c                	jne    80108217 <deallocuvm+0x82>
        panic("kfree");
8010820b:	c7 04 24 09 8c 10 80 	movl   $0x80108c09,(%esp)
80108212:	e8 26 83 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108217:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010821a:	89 04 24             	mov    %eax,(%esp)
8010821d:	e8 1a f5 ff ff       	call   8010773c <p2v>
80108222:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108225:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108228:	89 04 24             	mov    %eax,(%esp)
8010822b:	e8 42 a8 ff ff       	call   80102a72 <kfree>
      *pte = 0;
...
80108246:	0f 82 74 ff ff ff    	jb     801081c0 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108254:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108257:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010825b:	75 0c                	jne    80108269 <freevm+0x18>
    panic("freevm: no pgdir");
8010825d:	c7 04 24 0f 8c 10 80 	movl   $0x80108c0f,(%esp)
80108264:	e8 d4 82 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108269:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108270:	00 
80108271:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108278:	80 
80108279:	8b 45 08             	mov    0x8(%ebp),%eax
8010827c:	89 04 24             	mov    %eax,(%esp)
8010827f:	e8 11 ff ff ff       	call   80108195 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108284:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010828b:	eb 3c                	jmp    801082c9 <freevm+0x78>
    if(pgdir[i] & PTE_P){
8010828d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108290:	c1 e0 02             	shl    $0x2,%eax
80108293:	03 45 08             	add    0x8(%ebp),%eax
80108296:	8b 00                	mov    (%eax),%eax
80108298:	83 e0 01             	and    $0x1,%eax
8010829b:	84 c0                	test   %al,%al
8010829d:	74 26                	je     801082c5 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010829f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082a2:	c1 e0 02             	shl    $0x2,%eax
801082a5:	03 45 08             	add    0x8(%ebp),%eax
801082a8:	8b 00                	mov    (%eax),%eax
801082aa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801082af:	89 04 24             	mov    %eax,(%esp)
801082b2:	e8 85 f4 ff ff       	call   8010773c <p2v>
801082b7:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801082ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082bd:	89 04 24             	mov    %eax,(%esp)
801082c0:	e8 ad a7 ff ff       	call   80102a72 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801082c5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801082c9:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801082d0:	76 bb                	jbe    8010828d <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801082d8:	e8 95 a7 ff ff       	call   80102a72 <kfree>
}
801082dd:	c9                   	leave  
801082de:	c3                   	ret    
...
801082e2:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801082e5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082ec:	00 
...
801082fa:	e8 c0 f8 ff ff       	call   80107bbf <walkpgdir>
801082ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108302:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108306:	75 0c                	jne    80108314 <clearpteu+0x35>
    panic("clearpteu");
80108308:	c7 04 24 20 8c 10 80 	movl   $0x80108c20,(%esp)
8010830f:	e8 29 82 ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108314:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108317:	8b 00                	mov    (%eax),%eax
80108319:	89 c2                	mov    %eax,%edx
8010831b:	83 e2 fb             	and    $0xfffffffb,%edx
...
80108328:	53                   	push   %ebx
80108329:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010832c:	e8 b8 f9 ff ff       	call   80107ce9 <setupkvm>
80108331:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108334:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108338:	75 0a                	jne    80108344 <copyuvm+0x1f>
    return 0;
8010833a:	b8 00 00 00 00       	mov    $0x0,%eax
8010833f:	e9 fd 00 00 00       	jmp    80108441 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108344:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010834b:	e9 cc 00 00 00       	jmp    8010841c <copyuvm+0xf7>
...
80108365:	e8 55 f8 ff ff       	call   80107bbf <walkpgdir>
8010836a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010836d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108371:	75 0c                	jne    8010837f <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108373:	c7 04 24 2a 8c 10 80 	movl   $0x80108c2a,(%esp)
8010837a:	e8 be 81 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
8010837f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108382:	8b 00                	mov    (%eax),%eax
80108384:	83 e0 01             	and    $0x1,%eax
80108387:	85 c0                	test   %eax,%eax
80108389:	75 0c                	jne    80108397 <copyuvm+0x72>
      panic("copyuvm: page not present");
8010838b:	c7 04 24 44 8c 10 80 	movl   $0x80108c44,(%esp)
...
801083a9:	25 ff 0f 00 00       	and    $0xfff,%eax
801083ae:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801083b1:	e8 55 a7 ff ff       	call   80102b0b <kalloc>
801083b6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801083b9:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801083bd:	74 6e                	je     8010842d <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801083bf:	8b 45 e8             	mov    -0x18(%ebp),%eax
801083c2:	89 04 24             	mov    %eax,(%esp)
801083c5:	e8 72 f3 ff ff       	call   8010773c <p2v>
801083ca:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801083d1:	00 
801083d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801083d6:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083d9:	89 04 24             	mov    %eax,(%esp)
801083dc:	e8 dc cd ff ff       	call   801051bd <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
801083e1:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
801083e4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801083e7:	89 04 24             	mov    %eax,(%esp)
801083ea:	e8 40 f3 ff ff       	call   8010772f <v2p>
801083ef:	8b 55 f4             	mov    -0xc(%ebp),%edx
801083f2:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801083f6:	89 44 24 0c          	mov    %eax,0xc(%esp)
801083fa:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108401:	00 
80108402:	89 54 24 04          	mov    %edx,0x4(%esp)
80108406:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108409:	89 04 24             	mov    %eax,(%esp)
8010840c:	e8 44 f8 ff ff       	call   80107c55 <mappages>
80108411:	85 c0                	test   %eax,%eax
80108413:	78 1b                	js     80108430 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
...
80108422:	0f 82 28 ff ff ff    	jb     80108350 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010842b:	eb 14                	jmp    80108441 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
8010842d:	90                   	nop
8010842e:	eb 01                	jmp    80108431 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108430:	90                   	nop
...
80108437:	e8 15 fe ff ff       	call   80108251 <freevm>
  return 0;
8010843c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108441:	83 c4 44             	add    $0x44,%esp
80108444:	5b                   	pop    %ebx
80108445:	5d                   	pop    %ebp
80108446:	c3                   	ret    
...
8010844a:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
80108462:	e8 58 f7 ff ff       	call   80107bbf <walkpgdir>
...
8010849d:	e8 9a f2 ff ff       	call   8010773c <p2v>
}
801084a2:	c9                   	leave  
801084a3:	c3                   	ret    
...
801084ad:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801084b0:	e9 8b 00 00 00       	jmp    80108540 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801084b5:	8b 45 0c             	mov    0xc(%ebp),%eax
801084b8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801084bd:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801084cd:	e8 75 ff ff ff       	call   80108447 <uva2ka>
801084d2:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801084d5:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801084d9:	75 07                	jne    801084e2 <copyout+0x3e>
      return -1;
801084db:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801084e0:	eb 6d                	jmp    8010854f <copyout+0xab>
    n = PGSIZE - (va - va0);
801084e2:	8b 45 0c             	mov    0xc(%ebp),%eax
801084e5:	8b 55 ec             	mov    -0x14(%ebp),%edx
801084e8:	89 d1                	mov    %edx,%ecx
801084ea:	29 c1                	sub    %eax,%ecx
...
801084f9:	3b 45 14             	cmp    0x14(%ebp),%eax
801084fc:	76 06                	jbe    80108504 <copyout+0x60>
      n = len;
801084fe:	8b 45 14             	mov    0x14(%ebp),%eax
80108501:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108504:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108507:	8b 55 0c             	mov    0xc(%ebp),%edx
8010850a:	89 d1                	mov    %edx,%ecx
8010850c:	29 c1                	sub    %eax,%ecx
8010850e:	89 c8                	mov    %ecx,%eax
80108510:	03 45 e8             	add    -0x18(%ebp),%eax
80108513:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108516:	89 54 24 08          	mov    %edx,0x8(%esp)
8010851a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010851d:	89 54 24 04          	mov    %edx,0x4(%esp)
80108521:	89 04 24             	mov    %eax,(%esp)
80108524:	e8 94 cc ff ff       	call   801051bd <memmove>
    len -= n;
80108529:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010852c:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010852f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108532:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108535:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108538:	05 00 10 00 00       	add    $0x1000,%eax
8010853d:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108540:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108544:	0f 85 6b ff ff ff    	jne    801084b5 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
