...
int main(int argc, char *argv[])
{
  ...
  1d:	e8 4e 03 00 00       	call   370 <signal>
	
	printf(1, "Traps Performed: XXXX\n");
  22:	c7 44 24 04 13 08 00 	movl   $0x813,0x4(%esp)
  29:	00 
  2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  31:	e8 19 04 00 00       	call   44f <printf>
	printf(1, "Total Elapsed Time: XXXX\n");
  36:	c7 44 24 04 2a 08 00 	movl   $0x82a,0x4(%esp)
  3d:	00 
  3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  45:	e8 05 04 00 00       	call   44f <printf>
	printf(1, "Average Time Per Trap: XXXXX\n");
  4a:	c7 44 24 04 44 08 00 	movl   $0x844,0x4(%esp)
  51:	00 
  52:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  59:	e8 f1 03 00 00       	call   44f <printf>

	exit();
  5e:	e8 65 02 00 00       	call   2c8 <exit>
  63:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	0f b6 90 c8 0a 00 00 	movzbl 0xac8(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 545:	75 27                	jne    56e <printf+0x11f>
          s = "(null)";
 547:	c7 45 f4 62 08 00 00 	movl   $0x862,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 613:	a1 e4 0a 00 00       	mov    0xae4,%eax
...
free(void *ap)
{
 ...
 6d4:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 6d9:	c9                   	leave  
 6da:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 727:	e8 d8 fe ff ff       	call   604 <free>
  return freep;
 72c:	a1 e4 0a 00 00       	mov    0xae4,%eax
}
 731:	c9                   	leave  
 732:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 745:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 748:	a1 e4 0a 00 00       	mov    0xae4,%eax
 74d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 750:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 754:	75 23                	jne    779 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 756:	c7 45 f0 dc 0a 00 00 	movl   $0xadc,-0x10(%ebp)
 75d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 760:	a3 e4 0a 00 00       	mov    %eax,0xae4
 765:	a1 e4 0a 00 00       	mov    0xae4,%eax
 76a:	a3 dc 0a 00 00       	mov    %eax,0xadc
    base.s.size = 0;
 76f:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 776:	00 00 00 
  }
 ...
 7cc:	a3 e4 0a 00 00       	mov    %eax,0xae4
      return (void*)(p + 1);
 ...
 7d7:	eb 38                	jmp    811 <malloc+0xde>
    ...
    if(p == freep)
 7d9:	a1 e4 0a 00 00       	mov    0xae4,%eax
