...
int signal(int signum, sighandler_t handler)
{
  ...
  13:	e8 04 04 00 00       	call   41c <regis>
...
void handle_signal(int signum)
{
  ...
  1e:	89 e5                	mov    %esp,%ebp
	...
	// printf(1, "count = %d\n", count);
	--count;
  20:	a1 8c 0b 00 00       	mov    0xb8c,%eax
  25:	83 e8 01             	sub    $0x1,%eax
  28:	a3 8c 0b 00 00       	mov    %eax,0xb8c
	if(!count)
  2d:	a1 8c 0b 00 00       	mov    0xb8c,%eax
  32:	85 c0                	test   %eax,%eax
  34:	75 07                	jne    3d <handle_signal+0x20>
	{
		__asm__ ("movl $0x8f,4(%ebp)\n\t");
  36:	c7 45 04 8f 00 00 00 	movl   $0x8f,0x4(%ebp)
	}
}
  3d:	5d                   	pop    %ebp
  3e:	c3                   	ret    
...
int main(int argc, char *argv[])
{
  ...
  45:	83 ec 30             	sub    $0x30,%esp
	int x = 5;
  48:	c7 44 24 2c 05 00 00 	movl   $0x5,0x2c(%esp)
  4f:	00 
	int y = 0;
  50:	c7 44 24 28 00 00 00 	movl   $0x0,0x28(%esp)
  57:	00 
	int begin, end;
	int counts = count;
  58:	a1 8c 0b 00 00       	mov    0xb8c,%eax
  5d:	89 44 24 24          	mov    %eax,0x24(%esp)

	// printf(1, "anything\n");

	signal(SIGFPE, handle_signal);
  61:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  68:	00 
  69:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  70:	e8 8b ff ff ff       	call   0 <signal>

	// printf(1, "anything\n");
	
	begin = uptime();
  75:	e8 92 03 00 00       	call   40c <uptime>
  7a:	89 44 24 20          	mov    %eax,0x20(%esp)
	// printf(1, "The clock cycle now is: %d\n", begin);	
	x = x / y;
  7e:	8b 44 24 2c          	mov    0x2c(%esp),%eax
  82:	89 c2                	mov    %eax,%edx
  84:	c1 fa 1f             	sar    $0x1f,%edx
  87:	f7 7c 24 28          	idivl  0x28(%esp)
  8b:	89 44 24 2c          	mov    %eax,0x2c(%esp)
	end = uptime();
  8f:	e8 78 03 00 00       	call   40c <uptime>
  94:	89 44 24 1c          	mov    %eax,0x1c(%esp)

	// printf(1, "The clock cycle now is: %d\n", end);	
	printf(1, "Traps Performed: %d\n", counts);
  98:	8b 44 24 24          	mov    0x24(%esp),%eax
  9c:	89 44 24 08          	mov    %eax,0x8(%esp)
  a0:	c7 44 24 04 bf 08 00 	movl   $0x8bf,0x4(%esp)
  a7:	00 
  a8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  af:	e8 47 04 00 00       	call   4fb <printf>
	printf(1, "Total Elapsed Time: %d\n", (end - begin));
  b4:	8b 44 24 20          	mov    0x20(%esp),%eax
  b8:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  bc:	89 d1                	mov    %edx,%ecx
  be:	29 c1                	sub    %eax,%ecx
  c0:	89 c8                	mov    %ecx,%eax
  c2:	89 44 24 08          	mov    %eax,0x8(%esp)
  c6:	c7 44 24 04 d4 08 00 	movl   $0x8d4,0x4(%esp)
  cd:	00 
  ce:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d5:	e8 21 04 00 00       	call   4fb <printf>
	printf(1, "Average Time Per Trap: %d\n", (end - begin) / counts);
  da:	8b 44 24 20          	mov    0x20(%esp),%eax
  de:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  e2:	89 d1                	mov    %edx,%ecx
  e4:	29 c1                	sub    %eax,%ecx
  e6:	89 c8                	mov    %ecx,%eax
  e8:	89 c2                	mov    %eax,%edx
  ea:	c1 fa 1f             	sar    $0x1f,%edx
  ed:	f7 7c 24 24          	idivl  0x24(%esp)
  f1:	89 44 24 08          	mov    %eax,0x8(%esp)
  f5:	c7 44 24 04 ec 08 00 	movl   $0x8ec,0x4(%esp)
  fc:	00 
  fd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 104:	e8 f2 03 00 00       	call   4fb <printf>

	exit();
 109:	e8 66 02 00 00       	call   374 <exit>
 10e:	90                   	nop
 10f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 492:	0f b6 90 90 0b 00 00 	movzbl 0xb90(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5f1:	75 27                	jne    61a <printf+0x11f>
          s = "(null)";
 5f3:	c7 45 f4 07 09 00 00 	movl   $0x907,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bf:	a1 ac 0b 00 00       	mov    0xbac,%eax
...
free(void *ap)
{
 ...
 780:	a3 ac 0b 00 00       	mov    %eax,0xbac
}
 785:	c9                   	leave  
 786:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7d3:	e8 d8 fe ff ff       	call   6b0 <free>
  return freep;
 7d8:	a1 ac 0b 00 00       	mov    0xbac,%eax
}
 7dd:	c9                   	leave  
 7de:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7f1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7f4:	a1 ac 0b 00 00       	mov    0xbac,%eax
 7f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 800:	75 23                	jne    825 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 802:	c7 45 f0 a4 0b 00 00 	movl   $0xba4,-0x10(%ebp)
 809:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80c:	a3 ac 0b 00 00       	mov    %eax,0xbac
 811:	a1 ac 0b 00 00       	mov    0xbac,%eax
 816:	a3 a4 0b 00 00       	mov    %eax,0xba4
    base.s.size = 0;
 81b:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 822:	00 00 00 
  }
 ...
 878:	a3 ac 0b 00 00       	mov    %eax,0xbac
      return (void*)(p + 1);
 ...
 883:	eb 38                	jmp    8bd <malloc+0xde>
    ...
    if(p == freep)
 885:	a1 ac 0b 00 00       	mov    0xbac,%eax
