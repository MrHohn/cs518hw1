...
{	
   ...
   6:	c7 44 24 04 90 08 00 	movl   $0x890,0x4(%esp)
   d:	00 
   e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  15:	e8 b1 04 00 00       	call   4cb <printf>
    exit();
  1a:	e8 25 03 00 00       	call   344 <exit>
...
int main(void)
{
  ...
  83:	c7 44 24 04 a0 08 00 	movl   $0x8a0,0x4(%esp)
  8a:	00 
  8b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  92:	e8 34 04 00 00       	call   4cb <printf>
  97:	eb 1a                	jmp    b3 <main+0x94>
    else
        printf(1, "TEST FAILED: Final value of ecx is %d...\n", ecx);
  99:	89 c8                	mov    %ecx,%eax
  9b:	89 44 24 08          	mov    %eax,0x8(%esp)
  9f:	c7 44 24 04 cc 08 00 	movl   $0x8cc,0x4(%esp)
  a6:	00 
  a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ae:	e8 18 04 00 00       	call   4cb <printf>

    exit();
  b3:	e8 8c 02 00 00       	call   344 <exit>

000000b8 <handle_signal>:
}
...
void handle_signal(int signum)
{
  ...
  bb:	83 ec 18             	sub    $0x18,%esp
    printf(1, "in handler\n");
  be:	c7 44 24 04 f6 08 00 	movl   $0x8f6,0x4(%esp)
  c5:	00 
  c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  cd:	e8 f9 03 00 00       	call   4cb <printf>
    // exit();

    __asm__ ("movl $0x0,%ecx\n\t");
  d2:	b9 00 00 00 00       	mov    $0x0,%ecx
	// Add your code to skip the return ip here
    __asm__ ("movl $0x76,4(%ebp)\n\t");
  d7:	c7 45 04 76 00 00 00 	movl   $0x76,0x4(%ebp)
  de:	c9                   	leave  
  df:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	0f b6 90 84 0b 00 00 	movzbl 0xb84(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 5c1:	75 27                	jne    5ea <printf+0x11f>
          s = "(null)";
 5c3:	c7 45 f4 02 09 00 00 	movl   $0x902,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 68f:	a1 a0 0b 00 00       	mov    0xba0,%eax
...
free(void *ap)
{
 ...
 750:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 755:	c9                   	leave  
 756:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7a3:	e8 d8 fe ff ff       	call   680 <free>
  return freep;
 7a8:	a1 a0 0b 00 00       	mov    0xba0,%eax
}
 7ad:	c9                   	leave  
 7ae:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7c4:	a1 a0 0b 00 00       	mov    0xba0,%eax
 7c9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7d0:	75 23                	jne    7f5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7d2:	c7 45 f0 98 0b 00 00 	movl   $0xb98,-0x10(%ebp)
 7d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7dc:	a3 a0 0b 00 00       	mov    %eax,0xba0
 7e1:	a1 a0 0b 00 00       	mov    0xba0,%eax
 7e6:	a3 98 0b 00 00       	mov    %eax,0xb98
    base.s.size = 0;
 ...
 853:	eb 38                	jmp    88d <malloc+0xde>
    ...
    if(p == freep)
 855:	a1 a0 0b 00 00       	mov    0xba0,%eax
